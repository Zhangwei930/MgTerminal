...
export const enTerminalMessages: Messages = {
  ...
  'terminal.toolbar.sendSerialHex': 'Send hex bytes',
  'terminal.serialHex.title': 'Send hex bytes',
  'terminal.serialHex.description': 'Bytes are written to the device exactly as typed, without charset conversion.',
  'terminal.serialHex.input': 'Hex',
  'terminal.serialHex.byteCount': '{count} byte(s)',
  'terminal.serialHex.send': 'Send',
  'terminal.serialHex.error.empty': 'Enter one or more hex bytes.',
  'terminal.serialHex.error.odd_length': 'Hex must come in pairs — one digit is missing.',
  'terminal.serialHex.error.invalid_hex': 'Only 0-9 and A-F are allowed.',
  ...
  'terminal.follow.toolbar': 'Local follow',
  'terminal.follow.title': 'Local follow mode',
  'terminal.follow.desc':
    'Open a local viewer window on the same session stream. Only one person can type; viewers watch until you grant control.',
  'terminal.follow.start': 'Start follow',
  'terminal.follow.stop': 'Stop follow',
  'terminal.follow.openViewer': 'Open local viewer',
  'terminal.follow.requestControl': 'Request control',
  'terminal.follow.grantTo': 'Grant control to {name}',
  'terminal.follow.revoke': 'Revoke control (return to host)',
  'terminal.follow.peers': '{count} peer(s)',
  'terminal.follow.pending': '{count} request(s)',
  'terminal.follow.role.controller': 'Controlling',
  'terminal.follow.role.viewer': 'Watching',
  'terminal.follow.viewerTitle': 'Following · {label}',
  'terminal.follow.joining': 'Joining session…',
  'terminal.follow.toast.started': 'Follow mode started',
  'terminal.follow.toast.stopped': 'Follow mode stopped',
  'terminal.follow.toast.controlRequested': 'Control requested — host must grant',
  'terminal.follow.toast.granted': 'Control granted',
  'terminal.follow.toast.revoked': 'Control returned to host',
  'terminal.follow.toast.inputDenied': 'You are watching — request control to type',
  'terminal.follow.error.unavailable': 'Follow mode is unavailable in this environment',
  'terminal.follow.error.startFailed': 'Could not start follow mode',
  'terminal.follow.error.joinFailed': 'Could not join follow session',
  'terminal.follow.error.openViewerFailed': 'Could not open follow viewer',
  'terminal.follow.error.requestFailed': 'Could not request control',
  'terminal.follow.error.grantFailed': 'Could not grant control',
  'terminal.follow.error.revokeFailed': 'Could not revoke control',
  'terminal.follow.lan.tab': 'LAN',
  'terminal.follow.lan.desc': 'Viewers on the same network connect with a short-lived TCP invite. No cloud account.',
  'terminal.follow.lan.create': 'Create LAN invite',
  'terminal.follow.lan.inviteTitle': 'LAN invite (local network)',
  'terminal.follow.lan.code': 'Code',
  'terminal.follow.lan.copyShare': 'Copy invite string',
  'terminal.follow.lan.copied': 'Invite copied',
  'terminal.follow.lan.copyFailed': 'Could not copy invite',
  'terminal.follow.lan.created': 'LAN invite ready — share with viewers on your network',
  'terminal.follow.lan.joinToggle': 'Join an invite…',
  'terminal.follow.lan.joinPlaceholder': 'Paste magies-follow:1:… or :2:… invite',
  'terminal.follow.lan.join': 'Join session',
  'terminal.follow.lan.joinEmpty': 'Paste an invite string first',
  'terminal.follow.lan.viewerTitle': 'LAN follow · {label}',
  'terminal.follow.lan.connecting': 'Connecting over LAN…',
  'terminal.follow.lan.disconnected': 'LAN follow disconnected',
  'terminal.follow.lan.error.create': 'Could not create LAN invite',
  'terminal.follow.lan.error.join': 'Could not join LAN invite',
  'terminal.follow.wan.tab': 'WAN / Relay',
  'terminal.follow.wan.desc': 'Host and viewers dial out to a TCP relay (NAT-friendly). Use the built-in local relay for testing, or a public host running scripts/follow-relay.cjs.',
  'terminal.follow.wan.create': 'Create WAN invite',
  'terminal.follow.wan.created': 'WAN follow invite ready',
  'terminal.follow.wan.inviteTitle': 'WAN follow invite',
  'terminal.follow.wan.customRelay': 'Use custom relay host',
  'terminal.follow.wan.customRelayHint': 'Otherwise MagiesTerminal starts an embedded local relay on this machine.',
  'terminal.follow.wan.relayHostPlaceholder': 'relay.example.com',
  'terminal.follow.wan.localRelayBadge': 'local relay',
  'terminal.follow.wan.shareHint': 'Share the invite string. Viewers must reach the relay host:port (forward ports if needed).',
  'terminal.follow.wan.error.create': 'Could not create WAN invite',
  'terminal.follow.audit.show': 'Show audit log',
  'terminal.follow.audit.hide': 'Hide audit log',
  'terminal.follow.audit.title': 'Collaboration audit',
  'terminal.follow.audit.refresh': 'Refresh',
  ...
  'terminal.follow.audit.copiedNdjson': 'Audit NDJSON copied',
  'terminal.follow.audit.copyFailed': 'Could not copy audit log',
  'terminal.follow.audit.clear': 'Clear history on this device',
  'terminal.follow.audit.cleared': 'Audit history cleared',
  'terminal.follow.audit.clearFailed': 'Could not clear audit history',
  'terminal.follow.audit.type.follow_started': 'Follow started',
  'terminal.follow.audit.type.follow_stopped': 'Follow stopped',
  'terminal.follow.audit.type.peer_joined': 'Peer joined',
  'terminal.follow.audit.type.peer_left': 'Peer left',
  'terminal.follow.audit.type.control_requested': 'Control requested',
  'terminal.follow.audit.type.control_granted': 'Control granted',
  'terminal.follow.audit.type.control_revoked': 'Control revoked',
  'terminal.follow.audit.type.control_denied': 'Control denied',
  'terminal.follow.audit.type.input_denied': 'Input denied',

  'terminal.hex.enable': 'Show hex diagnostics',
  ...
  'terminal.hex.clear': 'Clear',
  'terminal.hex.close': 'Close hex panel',
  'terminal.hex.copied': 'Hex dump copied',
  'terminal.hex.copyFailed': 'Failed to copy hex dump',
  ...
  'terminal.toolbar.broadcastTargets': 'Broadcast targets',
  'terminal.toolbar.broadcastTargetCount': '{count} targets',
  'terminal.toolbar.broadcastScope.workspace': 'This workspace',
  'terminal.toolbar.broadcastScope.selected': 'Selected sessions',
  'terminal.toolbar.broadcastScope.group': 'Same host group',
  'terminal.toolbar.broadcastScope.window': 'This window',
  'terminal.toolbar.broadcastSelectSessions': 'Include sessions',
  'terminal.toolbar.broadcastExcludeSessions': 'Exclude sessions',
  'terminal.toolbar.broadcastNoSessions': 'No sessions in this workspace',
  ...
  'terminal.composeBar.broadcasting': 'Broadcasting to target sessions',
  ...
  'terminal.toolbar.aiAssist': "AI assist",
  'terminal.toolbar.aiExplain': "Explain selection with AI",
  'terminal.selection.explainDraft': "Explain this terminal output and suggest how to fix or proceed:",
  'terminal.menu.explainSelectionWithAI': "Explain selection with AI",
  ...
  'terminal.progress.autoReconnectGaveUp': 'Auto reconnect stopped after {attempts} failed attempts. Press Enter to reconnect manually.',
  ...
  'keychain.import.fido2Unsupported': 'This is a FIDO2 security key (sk-*) and cannot be imported directly. Add it to ssh-agent with ssh-add; connections then authenticate through the agent automatically.',
