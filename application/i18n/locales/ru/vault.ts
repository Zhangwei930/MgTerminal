...
export const ruVaultMessages: Messages = {
  ...
  'vault.dataSources.desc':
    'Подтягивайте инвентарь хостов из локального JSON или HTTP(S). Учётные данные остаются в Keychain MagiesTerminal — инвентарь не должен содержать секреты.',
  ...
  'vault.dataSources.empty': 'Пока нет JSON-источников. Добавьте файл или URL для синхронизации из CMDB / Ansible / API.',
  ...
  'vault.dataSources.pickFileTitle': 'Выберите JSON-инвентарь хостов',
  'vault.dataSources.type.file': 'JSON-файл',
  'vault.dataSources.type.fileDesc': 'Локальный путь, повторная синхронизация по запросу.',
  'vault.dataSources.type.http': 'HTTP(S)',
  'vault.dataSources.type.httpDesc': 'Загрузка инвентаря по URL (как API Bridge).',
  ...
  'vault.dataSources.secretsNote':
    'JSON-инвентарь может содержать только метаданные хоста (id, hostname, port, username, tags…). Пароли и закрытые ключи отклоняются.',
