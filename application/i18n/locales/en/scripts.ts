export const enScriptsMessages = {
  ...
  'scripts.trigger.actions': 'On match',
  'scripts.trigger.actionsHint': 'Choose what happens when the output pattern matches. Run script is the legacy default.',
  'scripts.trigger.action.runScript': 'Run script',
  'scripts.trigger.action.notify': 'Desktop notification',
  'scripts.trigger.action.sound': 'Play sound',
  'scripts.trigger.action.markTab': 'Mark tab',
  'scripts.trigger.action.startSessionLog': 'Start session log',
