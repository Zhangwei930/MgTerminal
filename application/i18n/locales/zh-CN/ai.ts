...
export const zhCNAiMessages: Messages = {
  ...
  'ai.chat.strictPrivacyExternalBlocked': '严格本地隐私模式已阻止外部 Agent。请选择 MagiesTerminal Agent 和回环地址提供商，或在「设置 → AI」中关闭该模式。',
  'ai.chat.strictPrivacyEndpointBlocked': '严格本地隐私模式已阻止此提供商，因为它不是回环地址。请选择 localhost 提供商，或在「设置 → AI」中关闭该模式。',
  'ai.title': 'AI',
  'ai.description': '配置 AI 提供商、Agent 和安全设置',
  'ai.localPrivacy.title': '本地 / 隐私模型',
  'ai.localPrivacy.badge': '本机运行',
  'ai.localPrivacy.description': '通过 Ollama 或 LM Studio 在本机运行模型。流量走 localhost，基础配置无需云端 API Key。',
  'ai.localPrivacy.addOllama': '添加 Ollama',
  'ai.localPrivacy.addLmStudio': '添加 LM Studio',
  'ai.localPrivacy.addedOllama': '已添加 Ollama',
  'ai.localPrivacy.addedLmStudio': '已添加 LM Studio',
  'ai.localPrivacy.safetyNote': 'Vault 密码与私钥绝不会发送给模型。写操作工具仍需确认模式审批。',
  'ai.localPrivacy.autoModeWarning': '当前权限为「自动」——写操作将跳过确认。本地代理建议使用「确认」。',
  'ai.localPrivacy.useConfirmMode': '改用确认',
  'ai.localPrivacy.strictMode': '严格本地隐私',
  'ai.localPrivacy.strictModeDescription': '仅允许回环地址的 AI 接口；阻止云端提供商、外部 Agent、跳转到远程主机以及网页搜索。',
  'ai.localPrivacy.probe': '探测工具能力',
  'ai.localPrivacy.probing': '探测中…',
  'ai.localPrivacy.selectModel': '请先选择默认模型',
  'ai.localPrivacy.toolsSupported': '支持工具调用',
  'ai.localPrivacy.toolsUnsupported': '未探测到工具调用能力',
  'ai.localPrivacy.toolsUnsupportedAdvice': '该模型上的 Agent 工具将无法使用。请改用声明支持 function calling 的模型版本，或仅将此模型用于纯对话。',
  'ai.localPrivacy.probeFailed': '探测失败：{detail}',
  'ai.safety.approvalAudit.title': '工具审批审计',
  'ai.safety.approvalAudit.description': 'MagiesTerminal 与 MCP 写工具最近的批准 / 拒绝记录（仅元数据，不含参数与密钥）。',
  'ai.safety.approvalAudit.empty': '暂无审批记录。',
  'ai.safety.approvalAudit.clear': '清空',
  'ai.safety.approvalAudit.requested': '请求中',
  'ai.safety.approvalAudit.approved': '已批准',
  'ai.safety.approvalAudit.denied': '已拒绝',
  'ai.safety.approvalAudit.timeout': '已超时',
  'ai.providers': '提供商',
  'ai.agents': 'Agent',
  ...
  'ai.providers.retryLoadModels': '重试',
  ...
  'ai.providers.liveModelCount': '已从服务商加载 {count} 个模型',
  'ai.providers.usingPresetModels': '使用离线预设列表（在线目录不可用）',
  'ai.providers.needApiKeyForModels': '请先填写 API Key 以加载在线模型列表',
  'ai.providers.fetchModelsFailed': '加载模型失败：{detail}',
  'ai.providers.emptyModelCatalog': '服务商返回了空的模型列表',
  'ai.providers.modelsBridgeUnavailable': '当前窗口无法拉取模型。请完全退出后重新打开 MagiesTerminal 再试。',
  ...
  // AI ChatGPT (Codex CLI under the hood)
  'ai.codex': 'ChatGPT',
  'ai.codex.title': 'ChatGPT（Codex）',
  'ai.codex.description': '接入 ChatGPT 编程代理（底层为 OpenAI Codex CLI）。可在此登录 ChatGPT，或使用兼容 OpenAI 的 API Key / 自定义接口。',
  ...
  'ai.codex.customConfigMissingEnvKey': '警告：环境变量 {envKey} 未在当前 shell 中设置。请 export 它（或从包含该变量的 shell 启动 magiesTerminal），否则 ChatGPT（Codex）无法鉴权。',
  'ai.codex.notConnected': '未连接',
  'ai.codex.statusUnknown': '状态未知',
  'ai.codex.path': '路径：',
  'ai.codex.notFoundHint': '在 PATH 中未找到 codex CLI。请安装 OpenAI Codex 或在下方指定可执行文件路径。',
  ...
  'ai.geminiProvider.hint': '在侧栏使用 Gemini：添加 Google AI 提供商并保存 API Key，选择 MagiesTerminal Agent，在聊天模型/提供商菜单中选 Gemini。',
  'ai.grokProvider.hint': '在侧栏使用 Grok：添加 xAI (Grok) 提供商并保存 API Key，选择 MagiesTerminal Agent，在聊天模型/提供商菜单中选 Grok。',
  'ai.chat.modelsLoading': '正在加载模型…',
  'ai.chat.modelsLoadFailed': '无法刷新模型列表',
  'ai.chat.modelsRetry': '重试',
  'ai.chat.modelsFromLive': '在线目录',
  'ai.chat.modelsFromPresets': '离线预设',
  ...
  'ai.quickMessages.search.placeholder': '搜索快捷消息…',
  'ai.quickMessages.noSearchResults': '没有匹配的快捷消息。',
  ...
  'ai.chat.emptyTitle': '开始对话',
  'ai.chat.emptyHint': '询问服务器相关问题、执行命令或获取配置帮助。',
  'ai.chat.role.you': '你',
  'ai.chat.role.assistant': '助手',
  'ai.chat.generating': '正在生成…',
  ...
  // 桌面宠物 (设置 → AI → 宠物)
  'ai.pet.title': '宠物',
  'ai.pet.enable': '启用桌面宠物',
  'ai.pet.enable.description': '显示一个可拖动的宠物,实时反映 AI 的工作状态。它会悬浮在所有应用之上,可拖到屏幕任意角落。',
  'ai.pet.image.title': '宠物图片',
  'ai.pet.image.upload': '上传图片',
  'ai.pet.image.reset': '恢复默认',
  'ai.pet.image.spriteCols': '列数',
  'ai.pet.image.spriteRows': '行数',
  'ai.pet.image.spriteHint': '如需使用多帧精灵图动画,请设置网格中等尺寸帧的排列行列数;单张静态图片请保持 1 x 1。',
  'ai.pet.image.invalidFile': '请选择 PNG 或 WebP 格式的图片。',
  'ai.pet.image.tooLarge': '图片过大(最大 6 MB)。',
  'ai.pet.image.saveFailed': '保存失败,请重试或换一张图片。',
  'ai.pet.hide': '隐藏宠物',
  'ai.pet.bubble.running': '正在处理…',
  'ai.pet.bubble.waiting': '等待你的确认',
  'ai.pet.bubble.done': '完成啦!',
  'ai.pet.bubble.failed': '出了点问题',
  'ai.pet.customCommand.label': '自定义命令(右键菜单)',
  'ai.pet.customCommand.placeholder': '例如 open -a Terminal',
  'ai.pet.customCommand.description': '在宠物右键菜单选择"运行自定义命令"时执行。按原样执行,不经过 shell——不支持管道、简单引号分组之外的转义或变量展开。',
  'ai.pet.hover.idle': '空闲',
  'ai.pet.hover.hint': '单击:打开对话 · 双击:主窗口 · 右键:更多操作',
  'ai.pet.bubble.runningTool': '正在运行 {tool}…',
  'ai.pet.notification.done.title': '任务完成',
  'ai.pet.notification.done.body': 'AI 任务已经跑完——点一下宠物看看结果。',
  'ai.pet.notification.failed.title': '任务失败',
  'ai.pet.notification.failed.body': 'AI 任务出了点问题。',
  'ai.pet.appearance.title': '外观',
  'ai.pet.appearance.scale': '大小',
  'ai.pet.appearance.opacity': '不透明度',
  'ai.pet.appearance.alwaysOnTop': '始终置顶',
  'ai.pet.appearance.alwaysOnTop.description': '让宠物始终悬浮在其他窗口之上。',
  'ai.pet.appearance.showBubble': '显示状态气泡',
  'ai.pet.behavior.title': '行为',
  'ai.pet.behavior.privacyMode': '隐私模式',
  'ai.pet.behavior.privacyMode.description': '气泡中隐藏当前正在运行的工具/任务名称,只显示通用状态。',
  'ai.pet.behavior.notifications': '长任务完成提醒',
  'ai.pet.behavior.notifications.description': '当运行超过 10 秒的任务完成时,弹出系统桌面通知。',
  'ai.pet.frameRanges.title': '各状态动画帧范围',
  'ai.pet.frameRanges.description': '如果用的是精灵图,可以为每种状态指定播放哪些帧。留空即默认循环整张精灵图。',
  'ai.pet.frameRanges.start': '起始帧',
  'ai.pet.frameRanges.end': '结束帧',
  'ai.pet.status.idle': '空闲',
  'ai.pet.status.running': '运行中',
  'ai.pet.status.waiting': '等待确认',
  'ai.pet.status.done': '完成',
  'ai.pet.status.failed': '失败',
  'ai.pet.customCommand.testRun': '测试运行',
  'ai.pet.customCommand.testRun.running': '测试中…',
  'ai.pet.customCommand.testRun.success': '看起来没问题——命令已启动。',
  'ai.pet.customCommand.testRun.failure': '失败:{error}',
};
