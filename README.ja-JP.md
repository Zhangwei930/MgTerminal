...
<p align="center">
  <a href="https://shell.magies.top">
    <img src="https://img.shields.io/github/v/release/JasonZhangDad/MgTerminal-releases?style=for-the-badge&logo=github&label=最新版をダウンロード&color=success" alt="最新版をダウンロード">
  </a>
</p>
...
[公式サイト](https://shell.magies.top) からお使いのプラットフォームに対応した最新版をダウンロードしてください。
...
または [GitHub Releases](https://github.com/JasonZhangDad/MgTerminal-releases/releases) ですべてのリリースを参照してください。

> **macOS ユーザーへ：** リリースはコード署名・notarization を行っていません。初回起動時に Gatekeeper が警告を表示します。アプリを右クリックして「開く」を選ぶか、`xattr -dr com.apple.quarantine /Applications/MagiesTerminal.app` を実行してください。アプリ内自動アップデートはバンドル置換方式のため、この警告は再発しません。
...
Copyright © 2025 JasonZhangDad および MagiesTerminal コントリビューター。

## Netcatty をベースにしています

MagiesTerminal は **[Netcatty](https://github.com/binaricat/Netcatty) のフォーク**（© binaricat および Netcatty コントリビューター）であり、Netcatty も GPL-3.0-or-later でライセンスされています。2025年12月以降、JasonZhangDad および MagiesTerminal コントリビューターによってブランド変更・UI/テーマの変更・機能追加などの重要な変更が加えられています。完全な帰属表示は [NOTICE](NOTICE) ファイルをご覧ください。
