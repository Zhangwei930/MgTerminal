...
export const ruVaultMessages: Messages = {
  ...
  'vault.hosts.bulkEdit.action': 'Изменить: {count}',
  'vault.hosts.bulkEdit.title': 'Изменение выбранных хостов',
  'vault.hosts.bulkEdit.description': 'Будет применено к хостам: {count}.',
  'vault.hosts.bulkEdit.blankHint': 'Пустое поле оставляет собственное значение каждого хоста.',
  'vault.hosts.bulkEdit.username': 'Имя пользователя',
  'vault.hosts.bulkEdit.group': 'Группа',
  'vault.hosts.bulkEdit.port': 'Порт',
  'vault.hosts.bulkEdit.addTags': 'Добавить теги (через запятую)',
  'vault.hosts.bulkEdit.managedSkipped': 'Исключено управляемых хостов: {count} — источник данных перезапишет правку при следующей синхронизации.',
  'vault.hosts.bulkEdit.apply': 'Обновить: {count}',
  'vault.hosts.bulkEdit.success': 'Обновлено хостов: {count}',
  ...
  'vault.import.sshConfig.defaultPathHint': "Путь к OpenSSH config по умолчанию",
  'vault.import.sshConfig.pickFileTitle': "Выберите файл SSH config",
  'vault.import.sshConfig.useDefaultManaged': "Использовать ~/.ssh/config (управляемый)",
  'vault.import.sshConfig.useDefaultImportOnly': "Использовать ~/.ssh/config (только импорт)",
  ...
  'vault.hosts.share': 'Поделиться инвентарём (JSON-файл)',
  'vault.hosts.shareAnsible': 'Поделиться инвентарём (Ansible INI-файл)',
  'vault.hosts.shareYaml': 'Поделиться инвентарём (Ansible YAML-файл)',
  'vault.hosts.copyJson': 'Копировать инвентарь JSON',
  'vault.hosts.copyAnsible': 'Копировать инвентарь Ansible INI',
  'vault.hosts.copyYaml': 'Копировать инвентарь Ansible YAML',
  ...
  'vault.hosts.share.toast.successYaml': 'Экспортировано хостов: {count} (Ansible YAML, только метаданные). Импорт через «Источники данных» — учётные данные остаются локально.',
  'vault.hosts.share.toast.successYamlSelected': 'Экспортировано выбранных хостов: {count} (Ansible YAML, только метаданные).',
  'vault.hosts.share.toast.copied': 'Скопировано хостов: {count} (JSON, только метаданные).',
  'vault.hosts.share.toast.copiedSelected': 'Скопировано выбранных: {count} (JSON, только метаданные).',
  'vault.hosts.share.toast.copiedAnsible': 'Скопировано хостов: {count} (Ansible INI, только метаданные).',
  'vault.hosts.share.toast.copiedAnsibleSelected': 'Скопировано выбранных: {count} (Ansible INI, только метаданные).',
  'vault.hosts.share.toast.copiedYaml': 'Скопировано хостов: {count} (Ansible YAML, только метаданные).',
  'vault.hosts.share.toast.copiedYamlSelected': 'Скопировано выбранных: {count} (Ansible YAML, только метаданные).',
  'vault.hosts.share.toast.copyFailed': 'Не удалось скопировать инвентарь в буфер обмена.',
  ...
  'vault.dataSources.desc':
    'Подтягивайте инвентарь хостов из локального файла или HTTP(S) (JSON MagiesTerminal или классический Ansible INI). Учётные данные остаются в Keychain MagiesTerminal — инвентарь не должен содержать секреты.',
  'vault.dataSources.count': 'Источников инвентаря: {count}',
  'vault.dataSources.add': 'Добавить источник',
  'vault.dataSources.addAndSync': 'Добавить и синхронизировать',
  'vault.dataSources.paste': 'Вставить инвентарь',
  'vault.dataSources.pasteLabel': 'Импорт из буфера',
  'vault.dataSources.empty': 'Пока нет источников. Добавьте JSON / Ansible INI файл или URL, или вставьте инвентарь из буфера.',
  ...
  'vault.dataSources.browse': 'Обзор',
  'vault.dataSources.pickFileTitle': 'Выберите инвентарь хостов (JSON или Ansible INI)',
  'vault.dataSources.type.file': 'Локальный файл',
  'vault.dataSources.type.fileDesc': 'Путь к JSON, Ansible INI или YAML; синхронизация по запросу.',
  'vault.dataSources.type.http': 'HTTP(S)',
  'vault.dataSources.type.httpDesc': 'Загрузка JSON / Ansible INI / YAML по URL (как API Bridge).',
  'vault.dataSources.field.path': 'Путь к файлу',
  'vault.dataSources.field.url': 'URL',
  'vault.dataSources.field.httpAuth': 'HTTP-заголовок авторизации (опционально)',
  'vault.dataSources.field.httpAuthHint':
    'Только для этого HTTP(S) источника. Разрешены: Authorization, X-Api-Key, X-Auth-Token, X-Access-Token. Хранится локально в vault, не попадает в экспорт инвентаря.',
  'vault.dataSources.field.httpAuthName': 'Заголовок',
  'vault.dataSources.field.httpAuthValue': 'Значение',
  'vault.dataSources.httpAuth.none': 'не задано',
  'vault.dataSources.fieldMapping.title': 'Сопоставление полей (необязательно)',
  'vault.dataSources.fieldMapping.hint': 'Для источников с другими именами полей. Укажите имя поля в исходном документе; пустое значение — использовать каноническое.',
  'vault.dataSources.fieldMapping.secretRejected': 'Поле нельзя читать из «{field}» — это скопировало бы учётные данные в инвентарь. Используйте идентичности из хранилища ключей.',
  'vault.dataSources.field.group': 'Группа vault',
  ...
  'vault.dataSources.sshConfigNote':
    'Также настроено источников ssh_config: {count} (через импорт). Они записывают изменения обратно в локальный SSH config.',
  'vault.dataSources.toast.pathRequired': 'Укажите путь к файлу или URL.',
  'vault.dataSources.toast.invalidUrl': 'URL должен начинаться с http:// или https://',
  'vault.dataSources.toast.pickFileUnavailable': 'Выбор файла недоступен в этой среде.',
  'vault.dataSources.toast.addedTitle': 'Источник добавлен',
  'vault.dataSources.toast.added': 'Источник инвентаря добавлен.',
  'vault.dataSources.toast.addFailedTitle': 'Не удалось добавить источник',
  ...
  'vault.dataSources.toast.pasteTitle': 'Импорт из буфера',
  'vault.dataSources.toast.pasteAdded': 'Инвентарь вставлен и добавлен как локальный источник.',
  'vault.dataSources.toast.pasteEmpty': 'Буфер обмена пуст.',
  'vault.dataSources.toast.pasteUnavailable': 'Импорт из буфера недоступен в этой среде.',
  'vault.dataSources.toast.pasteFailedTitle': 'Не удалось вставить инвентарь',
  ...
  'vault.dataSources.toast.removed': 'Источник отключён. Хосты остаются локальными неуправляемыми записями.',
  ...
  'portForward.channels.title': 'Активные каналы',
  'portForward.channels.empty': 'Нет активных соединений на туннелях.',
  'portForward.channels.count': '{count} открыто',
  'portForward.channels.col.rule': 'Правило',
  'portForward.channels.col.source': 'Источник',
  'portForward.channels.col.destination': 'Назначение',
  'portForward.channels.col.in': 'Вход',
  'portForward.channels.col.out': 'Выход',
  'portForward.channels.col.duration': 'Длительность',
  ...
  'sftp.context.bulkRename': 'Переименовать {count} объектов…',
  'sftp.bulkRename.title': 'Массовое переименование',
  'sftp.bulkRename.description': 'Будет переименовано выбранных объектов: {count}.',
  'sftp.bulkRename.pattern': 'Шаблон имени',
  'sftp.bulkRename.tokens': '{name} исходное имя · {ext} расширение · {n} счётчик',
  'sftp.bulkRename.startAt': 'Начать счёт с',
  'sftp.bulkRename.padding': 'Дополнить счётчик до',
  'sftp.bulkRename.preview': 'Предпросмотр',
  'sftp.bulkRename.noChanges': 'Этот шаблон ничего не меняет.',
  'sftp.bulkRename.confirm': 'Переименовать: {count}',
  'sftp.bulkRename.error.empty_pattern': 'Введите шаблон имени.',
  'sftp.bulkRename.error.invalid_name': 'Шаблон создаёт недопустимое имя файла.',
  'sftp.bulkRename.error.duplicate_target': 'Шаблон даёт двум файлам одно имя.',
  'sftp.bulkRename.error.collides_with_existing': 'Шаблон перезапишет файл, который не переименовывается.',
  ...
  'sftp.conflict.hint.existingNewer': "Существующий файл новее по времени изменения.",
  'sftp.conflict.hint.incomingNewer': "Входящий файл новее по времени изменения.",
  'sftp.conflict.hint.partialOverlap': "Размер существующего файла меньше входящего. «Продолжить» — с offset, «Заменить» — полная перезапись.",
  'sftp.conflict.action.stop': 'Остановить',
  'sftp.conflict.action.skip': 'Пропустить',
  'sftp.conflict.action.resume': "Продолжить",
  ...
  'hostDetails.proxyPanel.test': 'Проверить подключение к {host}',
  'hostDetails.proxyPanel.testOk': 'Прокси дошёл до хоста за {ms} мс',
  'hostDetails.proxyPanel.testError.auth': 'Прокси отклонил эти учётные данные.',
  'hostDetails.proxyPanel.testError.timeout': 'Прокси не ответил вовремя.',
  'hostDetails.proxyPanel.testError.refused': 'Прокси отклонил подключение.',
  'hostDetails.proxyPanel.testError.dns': 'Не удалось разрешить адрес прокси.',
  'hostDetails.proxyPanel.testError.invalid': 'Сначала заполните прокси и хост.',
  'hostDetails.proxyPanel.testError.failed': 'Не удалось подключиться к хосту через этот прокси.',
  ...
  'hostDetails.agent.pkcs11.title': 'Загрузить смарт-карту (PKCS#11)',
  'hostDetails.agent.pkcs11.desc':
    'Загрузить модуль PKCS#11 в системный SSH-агент (ssh-add -s). Нужен OpenSC или библиотека вендора — MagiesTerminal не поставляет драйверы.',
  'hostDetails.agent.pkcs11.pathPlaceholder': '/path/to/opensc-pkcs11.so',
  'hostDetails.agent.pkcs11.pinPlaceholder': 'PIN токена (необязательно; один раз для ssh-add)',
  'hostDetails.agent.pkcs11.browse': 'Обзор',
  'hostDetails.agent.pkcs11.load': 'Загрузить в агент',
  'hostDetails.agent.pkcs11.unload': 'Выгрузить',
  'hostDetails.agent.pkcs11.loaded': 'Модуль PKCS#11 загружен в агент',
  'hostDetails.agent.pkcs11.unloaded': 'Модуль PKCS#11 выгружен из агента',
  'hostDetails.agent.pkcs11.pathRequired': 'Укажите путь к модулю PKCS#11',
  'hostDetails.agent.pkcs11.pickTitle': 'Выберите модуль PKCS#11',
  'hostDetails.agent.pkcs11.pickUnavailable': 'Выбор файла недоступен',
  'hostDetails.agent.pkcs11.error.platform_unsupported': 'Загрузка PKCS#11 поддерживается только на macOS и Linux',
  'hostDetails.agent.pkcs11.error.agent_unavailable': 'SSH-агент недоступен',
  'hostDetails.agent.pkcs11.error.module_not_readable': 'Не удаётся прочитать файл модуля',
  'hostDetails.agent.pkcs11.error.module_path_invalid': 'Некорректный путь к модулю',
  'hostDetails.agent.pkcs11.error.ssh_add_failed': 'ssh-add не удался — проверьте модуль, PIN и агент',
  'hostDetails.agent.pkcs11.error.failed': 'Не удалось управлять модулем PKCS#11',
};
