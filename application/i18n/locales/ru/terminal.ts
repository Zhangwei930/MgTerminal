...
export const ruTerminalMessages: Messages = {
  ...
  'terminal.toolbar.sendSerialHex': 'Отправить hex-байты',
  'terminal.serialHex.title': 'Отправка hex-байтов',
  'terminal.serialHex.description': 'Байты записываются в устройство как есть, без перекодировки.',
  'terminal.serialHex.input': 'Hex',
  'terminal.serialHex.byteCount': 'Байтов: {count}',
  'terminal.serialHex.send': 'Отправить',
  'terminal.serialHex.error.empty': 'Введите хотя бы один hex-байт.',
  'terminal.serialHex.error.odd_length': 'Hex задаётся парами — не хватает одной цифры.',
  'terminal.serialHex.error.invalid_hex': 'Допустимы только 0-9 и A-F.',
  ...
  'terminal.follow.toolbar': 'Локальное следование',
  'terminal.follow.title': 'Режим локального следования',
  'terminal.follow.desc':
    'Откройте локальное окно просмотра того же потока сессии. Печатать может только один; зрители ждут выдачи управления.',
  'terminal.follow.start': 'Начать follow',
  'terminal.follow.stop': 'Остановить follow',
  'terminal.follow.openViewer': 'Открыть локальный просмотр',
  'terminal.follow.requestControl': 'Запросить управление',
  'terminal.follow.grantTo': 'Передать управление {name}',
  'terminal.follow.revoke': 'Отозвать управление (вернуть хосту)',
  'terminal.follow.peers': 'Участников: {count}',
  'terminal.follow.pending': 'Запросов: {count}',
  'terminal.follow.role.controller': 'Управляет',
  'terminal.follow.role.viewer': 'Смотрит',
  'terminal.follow.viewerTitle': 'Следование · {label}',
  'terminal.follow.joining': 'Подключение к сессии…',
  'terminal.follow.toast.started': 'Режим follow включён',
  'terminal.follow.toast.stopped': 'Режим follow выключен',
  'terminal.follow.toast.controlRequested': 'Запрос управления отправлен — ждите хоста',
  'terminal.follow.toast.granted': 'Управление передано',
  'terminal.follow.toast.revoked': 'Управление возвращено хосту',
  'terminal.follow.toast.inputDenied': 'Вы в режиме просмотра — запросите управление',
  'terminal.follow.error.unavailable': 'Режим follow недоступен в этой среде',
  'terminal.follow.error.startFailed': 'Не удалось включить follow',
  'terminal.follow.error.joinFailed': 'Не удалось присоединиться',
  'terminal.follow.error.openViewerFailed': 'Не удалось открыть окно просмотра',
  'terminal.follow.error.requestFailed': 'Не удалось запросить управление',
  'terminal.follow.error.grantFailed': 'Не удалось передать управление',
  'terminal.follow.error.revokeFailed': 'Не удалось отозвать управление',
  'terminal.follow.lan.create': 'Создать LAN-приглашение',
  'terminal.follow.lan.inviteTitle': 'LAN-приглашение (локальная сеть)',
  'terminal.follow.lan.code': 'Код',
  'terminal.follow.lan.copyShare': 'Копировать строку приглашения',
  'terminal.follow.lan.copied': 'Приглашение скопировано',
  'terminal.follow.lan.copyFailed': 'Не удалось скопировать',
  'terminal.follow.lan.created': 'LAN-приглашение готово — поделитесь в локальной сети',
  'terminal.follow.lan.joinToggle': 'Присоединиться по LAN…',
  'terminal.follow.lan.joinPlaceholder': 'Вставьте magies-follow:1:…',
  'terminal.follow.lan.join': 'Войти в LAN-сессию',
  'terminal.follow.lan.joinEmpty': 'Сначала вставьте приглашение',
  'terminal.follow.lan.viewerTitle': 'LAN follow · {label}',
  'terminal.follow.lan.connecting': 'Подключение по LAN…',
  'terminal.follow.lan.disconnected': 'LAN follow отключён',
  'terminal.follow.lan.error.create': 'Не удалось создать LAN-приглашение',
  'terminal.follow.lan.error.join': 'Не удалось присоединиться',
  'terminal.follow.audit.show': 'Показать журнал аудита',
  'terminal.follow.audit.hide': 'Скрыть журнал аудита',
  'terminal.follow.audit.title': 'Аудит совместной работы',
  'terminal.follow.audit.refresh': 'Обновить',
  ...
  'terminal.follow.audit.copiedNdjson': 'NDJSON скопирован',
  'terminal.follow.audit.copyFailed': 'Не удалось скопировать журнал',
  'terminal.follow.audit.clear': 'Очистить историю на устройстве',
  'terminal.follow.audit.cleared': 'История аудита очищена',
  'terminal.follow.audit.clearFailed': 'Не удалось очистить историю',
  'terminal.follow.audit.type.follow_started': 'Follow запущен',
  'terminal.follow.audit.type.follow_stopped': 'Follow остановлен',
  'terminal.follow.audit.type.peer_joined': 'Участник присоединился',
  'terminal.follow.audit.type.peer_left': 'Участник вышел',
  'terminal.follow.audit.type.control_requested': 'Запрос управления',
  'terminal.follow.audit.type.control_granted': 'Управление выдано',
  'terminal.follow.audit.type.control_revoked': 'Управление отозвано',
  'terminal.follow.audit.type.control_denied': 'Управление отклонено',
  'terminal.follow.audit.type.input_denied': 'Ввод запрещён',

  'terminal.hex.enable': 'Показать hex-диагностику',
  ...
  'terminal.hex.clear': 'Очистить',
  'terminal.hex.close': 'Закрыть hex-панель',
  'terminal.hex.copied': 'Hex-дамп скопирован',
  'terminal.hex.copyFailed': 'Не удалось скопировать hex-дамп',
  'terminal.toolbar.broadcast': 'Трансляция',
  'terminal.paste.dangerous.title': 'Опасная вставка',
  'terminal.paste.dangerous.message': 'Эта вставка выглядит опасной.\n\nСовпадение: {pattern}\nСтрока: {command}\n\nВсё равно отправить?',
  'terminal.paste.dangerous.confirm': 'Вставить всё равно',
  'terminal.toolbar.broadcastEnable': 'Включить режим трансляции',
  'terminal.toolbar.broadcastDisable': 'Отключить режим трансляции',
  'terminal.toolbar.broadcastTargets': 'Цели трансляции',
  'terminal.toolbar.broadcastTargetCount': '{count} целей',
  'terminal.toolbar.broadcastScope.workspace': 'Это рабочее пространство',
  'terminal.toolbar.broadcastScope.selected': 'Выбранные сеансы',
  'terminal.toolbar.broadcastScope.group': 'Та же группа хостов',
  'terminal.toolbar.broadcastScope.window': 'Это окно',
  'terminal.toolbar.broadcastSelectSessions': 'Включить сеансы',
  'terminal.toolbar.broadcastExcludeSessions': 'Исключить сеансы',
  'terminal.toolbar.broadcastNoSessions': 'В этом рабочем пространстве нет сеансов',
  ...
  'terminal.toolbar.aiAssist': "ИИ-помощь",
  'terminal.toolbar.aiExplain': "Объяснить выделение с ИИ",
  'terminal.selection.explainDraft': "Объясни этот вывод терминала и предложи, как исправить или продолжить:",
  'terminal.menu.explainSelectionWithAI': "Объяснить выделение с ИИ",
  ...
  'terminal.progress.autoReconnectScheduled': 'Соединение потеряно. Переподключение через {seconds}с (попытка {attempt}).',
  'terminal.progress.autoReconnectAttempt': 'Автопереподключение (попытка {attempt})...',
  'terminal.progress.autoReconnectGaveUp': 'Автопереподключение остановлено после {attempts} неудачных попыток. Нажмите Enter для ручного переподключения.',
  ...
  'keychain.import.fido2Unsupported': 'Это ключ безопасности FIDO2 (sk-*), его нельзя импортировать напрямую. Добавьте его в ssh-agent через ssh-add; подключения будут проходить аутентификацию через агент автоматически.',
