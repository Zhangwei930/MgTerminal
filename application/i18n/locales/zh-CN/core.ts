...
export const zhCNCoreMessages: Messages = {
  ...
  'settings.sessionLogs.playCast': '播放 .cast 录制',
  'settings.sessionLogs.playCastHint': '回放以 asciinema cast 格式保存的录制，带时间轴与倍速。',
  'castPlayer.title': 'Cast 回放',
  'castPlayer.description': '回放 asciinema cast v2 录制。文件在本地读取，不会离开这台设备。',
  'castPlayer.open': '打开 .cast 文件',
  'castPlayer.noFile': '尚未载入录制',
  'castPlayer.play': '播放',
  'castPlayer.pause': '暂停',
  'castPlayer.restart': '重新开始',
  'castPlayer.seek': '跳转',
  'castPlayer.skipped': '已跳过 {count} 行损坏内容——该录制可能被中途截断。',
  'castPlayer.error.empty': '文件为空。',
  'castPlayer.error.header': '首行不是合法的 cast 头部。',
  'castPlayer.error.version': '仅支持 asciinema cast v2 录制。',
  'castPlayer.error.dimensions': '头部缺少有效的宽高。',
  ...
  'vault.nav.logs': '日志',
  'vault.nav.databases': '数据库',

  'db.connections.new': '新建连接',
  'db.connections.empty': '还没有保存的数据库连接',
  'db.connections.selectHost': '选择 SSH 主机',
  'db.connections.selectEngine': '数据库类型',
  'db.connections.label': '连接名称',
  'db.connections.database': '数据库名',
  'db.connections.username': '数据库用户名',
  'db.connections.password': '数据库密码',
  'db.connections.edit': '编辑连接',
  'db.connections.useTunnel': '通过 SSH 隧道连接',
  'db.connections.tunnelHint': '数据库不在本机可达时勾选，选择一台已保存的 SSH 主机作为跳板',
  'db.connections.directHint': '直接填写数据库地址即可',
  'db.connections.remoteHost': '主机地址（从 SSH 服务器视角）',
  'db.connections.remotePort': '端口',
  'db.connections.passwordKeep': '留空表示不修改密码',
  'db.connections.tls': '加密传输 (TLS)',
  'db.connections.tlsDisable': '关闭',
  'db.connections.tlsRequire': '加密，但不校验证书',
  'db.connections.tlsVerify': '加密并校验证书',
  'db.connections.tlsHint': '直连默认不加密。建议选「加密并校验」；自签证书可选中间那项。走 SSH 隧道时无需开启。',
  'db.connections.filePath': '数据库文件',
  'db.connections.filePathHint': 'SQLite 是本机上的一个文件——没有主机、端口和账号，也不需要隧道。',
  'db.workspace.run': '运行',
  'db.workspace.cancel': '取消',
  'db.workspace.connecting': '连接中…',
  'db.workspace.rowsAffected': '影响 {count} 行',
  'db.workspace.rowCount': '{count} 行',
  'db.workspace.filterRows': '筛选行…',
  'db.workspace.prevPage': '上一页',
  'db.workspace.nextPage': '下一页',
  'db.workspace.pageRange': '第 {from}–{to} 行',
  'db.workspace.perPage': '每页 {count} 行',
  ...
  'db.designer.title': '设计表',
  'db.designer.newTable': '新建表',
  'db.designer.tableName': '表名',
  'db.designer.column': '字段',
  'db.designer.type': '类型',
  'db.designer.nullable': '可空',
  'db.designer.primaryKey': '主键',
  'db.designer.default': '默认值',
  'db.designer.addColumn': '添加字段',
  'db.designer.removeColumn': '删除字段',
  'db.designer.preview': 'SQL 预览',
  'db.designer.noChanges': '没有需要应用的变更。',
  'db.designer.apply': '应用',
  'db.designer.applying': '正在应用…',
  'db.designer.cancel': '取消',
  'db.schema.design': '设计表',
  'db.schema.newTable': '新建表',
  'db.schema.dropTable': '删除表',
  'db.schema.dropTableConfirm': '确定删除 {name}？此操作不可撤销。',
  ...
  'db.export.html': 'HTML',
  'db.dump.export': '导出整库',
  'db.dump.restore': '从文件还原…',
  'db.dump.running': '正在读取所有表…',
  'db.dump.restoring': '正在执行文件…',
  'db.dump.chooseFile': '选择要执行的 .sql 文件',
  'db.dump.empty': '该文件没有可执行的语句。',
  'db.dump.restoreConfirm': '将文件中的 {count} 条语句在当前数据库上执行？此操作不可撤销。',
  'db.builder.open': '查询构建器',
  'db.builder.title': '查询构建器',
  'db.builder.table': '表',
  'db.builder.selectTable': '先选一张表。',
  'db.builder.columns': '字段',
  'db.builder.allColumnsHint': '一个都不选表示查询全部字段。',
  'db.builder.filters': '筛选条件（需同时满足）',
  'db.builder.addFilter': '添加条件',
  'db.builder.sort': '排序',
  'db.builder.addSort': '添加排序',
  'db.builder.limit': '行数上限',
  'db.builder.preview': 'SQL',
  'db.builder.apply': '放入编辑器',
  'db.builder.close': '关闭',
  'db.import.title': '导入数据',
  'db.import.chooseFile': '选择 CSV 或 JSON 文件…',
  'db.import.targetTable': '目标表',
  'db.import.createTable': '根据文件自动建表',
  'db.import.preview': '预览',
  'db.import.rowsFound': '{count} 行，{columns} 列',
  'db.import.run': '导入',
  'db.import.running': '正在导入…',
  'db.import.cancel': '取消',
  'db.import.failed': '无法读取该文件。',
  'db.schema.import': '导入数据…',
  'db.explain.run': '执行计划',
  'db.explain.hint': '查看执行计划，不实际运行查询',
  'db.explain.selectOnly': '只有 SELECT 语句可以查看执行计划。',
  'db.history.title': '查询历史',
  'db.history.filter': '搜索历史…',
  'db.history.empty': '还没有查询记录。',
  'db.history.favourite': '收藏这条查询',
  'db.history.favouritesOnly': '只看收藏',
  ...
  'db.er.close': '关闭',
  'db.diff.title': '结构对比',
  'db.diff.explain': '拿另一个连接与「{source}」对比，并生成一份把它对齐的脚本。',
  'db.diff.target': '对比目标',
  'db.diff.pick': '选择一个连接…',
  'db.diff.noCandidates': '需要再保存一个连接才能对比。',
  'db.diff.safety': '只有「新增」类语句可以直接运行。任何可能丢数据的操作——删除、改类型、收紧可空性——都会以注释形式输出，由你阅读后决定。',
  'db.diff.compare': '开始对比',
  'db.diff.reading': '正在读取第 {done} / {total} 张表…',
  'db.diff.close': '关闭',
