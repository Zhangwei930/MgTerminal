...
export const zhCNCoreMessages: Messages = {
  ...
  'vault.dataSources.desc':
    '从本地 JSON 文件或 HTTP(S) 接口拉取主机清单。凭据仍保存在 MagiesTerminal Keychain — 清单中不得包含密钥。',
  'vault.dataSources.count': '{count} 个清单数据源',
  'vault.dataSources.add': '添加数据源',
  'vault.dataSources.addAndSync': '添加并同步',
  'vault.dataSources.empty': '还没有 JSON 清单数据源。可添加文件或 URL，从 CMDB / Ansible / 自定义 API 同步主机。',
  ...
  'vault.dataSources.pickFileTitle': '选择主机清单 JSON',
  'vault.dataSources.type.file': 'JSON 文件',
  'vault.dataSources.type.fileDesc': '本地文件路径，按需重新同步。',
  'vault.dataSources.type.http': 'HTTP(S)',
  'vault.dataSources.type.httpDesc': '从 URL 拉取清单（类似 API Bridge）。',
  ...
  'vault.dataSources.secretsNote':
    '清单 JSON 只能包含主机元数据（id、hostname、port、username、tags…）。密码与私钥会被拒绝。',
