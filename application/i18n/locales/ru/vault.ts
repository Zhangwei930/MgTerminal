...
export const ruVaultMessages: Messages = {
  ...
  'vault.dataSources.type.fileDesc': 'Путь к JSON или Ansible INI; синхронизация по запросу.',
  'vault.dataSources.type.http': 'HTTP(S)',
  'vault.dataSources.type.httpDesc': 'Загрузка JSON или Ansible INI по URL (как API Bridge).',
