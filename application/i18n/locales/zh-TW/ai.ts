...
export const zhTWAiMessages: Messages = {
  ...
  'ai.localPrivacy.title': '本機 / 隱私模型',
  'ai.localPrivacy.badge': '本機執行',
  'ai.localPrivacy.description': '透過 Ollama 或 LM Studio 在本機執行模型。流量走 localhost，基本設定不需雲端 API Key。',
  'ai.localPrivacy.addOllama': '新增 Ollama',
  'ai.localPrivacy.addLmStudio': '新增 LM Studio',
  'ai.localPrivacy.addedOllama': '已新增 Ollama',
  'ai.localPrivacy.addedLmStudio': '已新增 LM Studio',
  'ai.localPrivacy.safetyNote': 'Vault 密碼與私鑰絕不會傳送給模型。寫入工具仍需確認模式核准。',
  'ai.localPrivacy.autoModeWarning': '目前權限為「自動」——寫入將略過確認。本機代理建議使用「確認」。',
  'ai.localPrivacy.useConfirmMode': '改用確認',
  'ai.safety.approvalAudit.title': '工具核准稽核',
  'ai.safety.approvalAudit.description': 'MagiesTerminal 與 MCP 寫入工具最近的核准 / 拒絕紀錄（僅中繼資料，不含參數與密鑰）。',
  'ai.safety.approvalAudit.empty': '尚無核准紀錄。',
  'ai.safety.approvalAudit.clear': '清除',
  'ai.safety.approvalAudit.requested': '請求中',
  'ai.safety.approvalAudit.approved': '已核准',
  'ai.safety.approvalAudit.denied': '已拒絕',
  'ai.safety.approvalAudit.timeout': '已逾時',
  'ai.providers': '供應商',
  'ai.agents': 'Agent',
  ...
  // 桌面寵物 (設定 → AI → 寵物)
  'ai.pet.title': '寵物',
  'ai.pet.enable': '啟用桌面寵物',
  'ai.pet.enable.description': '顯示一個可拖曳的寵物,即時反映 AI 的工作狀態。它會懸浮在所有應用程式之上,可拖到螢幕任意角落。',
  'ai.pet.image.title': '寵物圖片',
  'ai.pet.image.upload': '上傳圖片',
  'ai.pet.image.reset': '恢復預設',
  'ai.pet.image.spriteCols': '欄數',
  'ai.pet.image.spriteRows': '列數',
  'ai.pet.image.spriteHint': '如需使用多幀精靈圖動畫,請設定網格中等尺寸幀的排列欄列數;單張靜態圖片請保持 1 x 1。',
  'ai.pet.image.invalidFile': '請選擇 PNG 或 WebP 格式的圖片。',
  'ai.pet.image.tooLarge': '圖片過大(最大 6 MB)。',
  'ai.pet.image.saveFailed': '儲存失敗,請重試或換一張圖片。',
  'ai.pet.hide': '隱藏寵物',
  'ai.pet.bubble.running': '正在處理…',
  'ai.pet.bubble.waiting': '等待你的確認',
  'ai.pet.bubble.done': '完成了!',
  'ai.pet.bubble.failed': '出了點問題',
  'ai.pet.customCommand.label': '自訂命令(右鍵選單)',
  'ai.pet.customCommand.placeholder': '例如 open -a Terminal',
  'ai.pet.customCommand.description': '在寵物右鍵選單選擇「執行自訂命令」時執行。按原樣執行,不經過 shell——不支援管線、簡單引號分組之外的轉義或變數展開。',
  'ai.pet.hover.idle': '閒置',
  'ai.pet.hover.hint': '單擊:開啟對話 · 雙擊:主視窗 · 右鍵:更多操作',
  'ai.pet.bubble.runningTool': '正在執行 {tool}…',
  'ai.pet.notification.done.title': '任務完成',
  'ai.pet.notification.done.body': 'AI 任務已經跑完——點一下寵物看看結果。',
  'ai.pet.notification.failed.title': '任務失敗',
  'ai.pet.notification.failed.body': 'AI 任務出了點問題。',
  'ai.pet.appearance.title': '外觀',
  'ai.pet.appearance.scale': '大小',
  'ai.pet.appearance.opacity': '不透明度',
  'ai.pet.appearance.alwaysOnTop': '永遠置頂',
  'ai.pet.appearance.alwaysOnTop.description': '讓寵物永遠懸浮在其他視窗之上。',
  'ai.pet.appearance.showBubble': '顯示狀態氣泡',
  'ai.pet.behavior.title': '行為',
  'ai.pet.behavior.privacyMode': '隱私模式',
  'ai.pet.behavior.privacyMode.description': '氣泡中隱藏目前執行中的工具/任務名稱,只顯示通用狀態。',
  'ai.pet.behavior.notifications': '長任務完成提醒',
  'ai.pet.behavior.notifications.description': '當執行超過 10 秒的任務完成時,彈出系統桌面通知。',
  'ai.pet.frameRanges.title': '各狀態動畫幀範圍',
  'ai.pet.frameRanges.description': '如果用的是精靈圖,可以為每種狀態指定播放哪些幀。留空即預設循環整張精靈圖。',
  'ai.pet.frameRanges.start': '起始幀',
  'ai.pet.frameRanges.end': '結束幀',
  'ai.pet.status.idle': '閒置',
  'ai.pet.status.running': '執行中',
  'ai.pet.status.waiting': '等待確認',
  'ai.pet.status.done': '完成',
  'ai.pet.status.failed': '失敗',
  'ai.pet.customCommand.testRun': '測試執行',
  'ai.pet.customCommand.testRun.running': '測試中…',
  'ai.pet.customCommand.testRun.success': '看起來沒問題——命令已啟動。',
  'ai.pet.customCommand.testRun.failure': '失敗:{error}',
};
