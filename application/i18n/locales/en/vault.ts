...
export const enVaultMessages: Messages = {
  ...
  'vault.import.sshConfig.defaultPathHint': "Default OpenSSH config path",
  'vault.import.sshConfig.pickFileTitle': "Select SSH config file",
  'vault.import.sshConfig.useDefaultManaged': "Use ~/.ssh/config (managed)",
  'vault.import.sshConfig.useDefaultImportOnly': "Use ~/.ssh/config (import only)",
  ...
  'vault.hosts.share': 'Share inventory (JSON file)',
  'vault.hosts.shareAnsible': 'Share inventory (Ansible INI file)',
  'vault.hosts.shareYaml': 'Share inventory (Ansible YAML file)',
  'vault.hosts.copyJson': 'Copy inventory JSON',
  'vault.hosts.copyAnsible': 'Copy inventory Ansible INI',
  'vault.hosts.copyYaml': 'Copy inventory Ansible YAML',
  ...
  'vault.hosts.share.toast.successYaml': 'Exported {count} hosts as metadata-only Ansible inventory YAML. Import via Data Sources — credentials stay local.',
  'vault.hosts.share.toast.successYamlSelected': 'Exported {count} selected hosts as metadata-only Ansible inventory YAML.',
  'vault.hosts.share.toast.copied': 'Copied {count} hosts as metadata-only inventory JSON.',
  'vault.hosts.share.toast.copiedSelected': 'Copied {count} selected hosts as metadata-only inventory JSON.',
  'vault.hosts.share.toast.copiedAnsible': 'Copied {count} hosts as metadata-only Ansible inventory INI.',
  'vault.hosts.share.toast.copiedAnsibleSelected': 'Copied {count} selected hosts as metadata-only Ansible inventory INI.',
  'vault.hosts.share.toast.copiedYaml': 'Copied {count} hosts as metadata-only Ansible inventory YAML.',
  'vault.hosts.share.toast.copiedYamlSelected': 'Copied {count} selected hosts as metadata-only Ansible inventory YAML.',
  'vault.hosts.share.toast.copyFailed': 'Could not copy inventory to the clipboard.',
  ...
  'vault.dataSources.desc':
    'Pull host inventory from a local file or HTTP(S) endpoint (MagiesTerminal JSON or classic Ansible INI). Credentials stay in MagiesTerminal Keychain — inventory must not include secrets.',
  'vault.dataSources.count': '{count} inventory source(s)',
  'vault.dataSources.add': 'Add source',
  'vault.dataSources.addAndSync': 'Add & sync',
  'vault.dataSources.paste': 'Paste inventory',
  'vault.dataSources.pasteLabel': 'Clipboard import',
  'vault.dataSources.empty': 'No inventory sources yet. Add a JSON/Ansible INI file or URL, or paste inventory from the clipboard.',
  ...
  'vault.dataSources.browse': 'Browse',
  'vault.dataSources.pickFileTitle': 'Select host inventory (JSON or Ansible INI)',
  'vault.dataSources.type.file': 'Local file',
  'vault.dataSources.type.fileDesc': 'JSON, Ansible INI, or YAML path; re-sync on demand.',
  'vault.dataSources.type.http': 'HTTP(S)',
  'vault.dataSources.type.httpDesc': 'Fetch JSON / Ansible INI / YAML from a URL (API Bridge style).',
  'vault.dataSources.field.path': 'File path',
  'vault.dataSources.field.url': 'URL',
  'vault.dataSources.field.httpAuth': 'HTTP auth header (optional)',
  'vault.dataSources.field.httpAuthHint':
    'Sent only for this HTTPS/HTTP source. Allowed headers: Authorization, X-Api-Key, X-Auth-Token, X-Access-Token. Stored with vault data; never exported in inventory shares.',
  'vault.dataSources.field.httpAuthName': 'Header',
  'vault.dataSources.field.httpAuthValue': 'Value',
  'vault.dataSources.httpAuth.none': 'not set',
  'vault.dataSources.fieldMapping.title': 'Field mapping (optional)',
  'vault.dataSources.fieldMapping.hint': 'For feeds that do not use the canonical names. Enter the field name in the source document; leave blank to use the canonical one.',
  'vault.dataSources.fieldMapping.secretRejected': 'A field cannot be read from "{field}" — that would copy a credential into the inventory. Use Keychain identities instead.',
  'vault.dataSources.field.group': 'Vault group',
  ...
  'vault.dataSources.sshConfigNote':
    '{count} ssh_config managed source(s) are configured via Import. They write back to the local SSH config file.',
  'vault.dataSources.toast.pathRequired': 'Enter a file path or URL.',
  'vault.dataSources.toast.invalidUrl': 'URL must start with http:// or https://',
  'vault.dataSources.toast.pickFileUnavailable': 'File picker is unavailable in this environment.',
  'vault.dataSources.toast.addedTitle': 'Source added',
  'vault.dataSources.toast.added': 'Inventory source was added.',
  'vault.dataSources.toast.addFailedTitle': 'Could not add source',
  ...
  'vault.dataSources.toast.pasteTitle': 'Clipboard import',
  'vault.dataSources.toast.pasteAdded': 'Inventory pasted and added as a local source.',
  'vault.dataSources.toast.pasteEmpty': 'Clipboard is empty.',
  'vault.dataSources.toast.pasteUnavailable': 'Clipboard import is unavailable in this environment.',
  'vault.dataSources.toast.pasteFailedTitle': 'Could not paste inventory',
  ...
  'vault.dataSources.toast.removed': 'Inventory source detached. Hosts remain as local unmanaged entries.',
  ...
  'portForward.channels.title': 'Active channels',
  'portForward.channels.empty': 'No live connections on active tunnels.',
  'portForward.channels.count': '{count} open',
  'portForward.channels.col.rule': 'Rule',
  'portForward.channels.col.source': 'Source',
  'portForward.channels.col.destination': 'Destination',
  'portForward.channels.col.in': 'In',
  'portForward.channels.col.out': 'Out',
  'portForward.channels.col.duration': 'Duration',
  ...
  'sftp.context.bulkRename': 'Rename {count} items…',
  'sftp.bulkRename.title': 'Bulk rename',
  'sftp.bulkRename.description': 'Renaming {count} selected items.',
  'sftp.bulkRename.pattern': 'Name pattern',
  'sftp.bulkRename.tokens': '{name} original name · {ext} extension · {n} counter',
  'sftp.bulkRename.startAt': 'Start counter at',
  'sftp.bulkRename.padding': 'Pad counter to',
  'sftp.bulkRename.preview': 'Preview',
  'sftp.bulkRename.noChanges': 'This pattern changes nothing.',
  'sftp.bulkRename.confirm': 'Rename {count}',
  'sftp.bulkRename.error.empty_pattern': 'Enter a name pattern.',
  'sftp.bulkRename.error.invalid_name': 'The pattern produces a name that is not a valid file name.',
  'sftp.bulkRename.error.duplicate_target': 'This pattern gives two files the same name.',
  'sftp.bulkRename.error.collides_with_existing': 'This pattern would overwrite a file that is not being renamed.',
  ...
  'sftp.conflict.hint.existingNewer': "The existing file is newer by modification time.",
  'sftp.conflict.hint.incomingNewer': "The incoming file is newer by modification time.",
  'sftp.conflict.hint.partialOverlap': "Existing size is smaller than the incoming file — a prior transfer may have been incomplete. Use Resume to continue from the existing bytes, or Replace to rewrite fully.",
  'sftp.conflict.action.stop': 'Stop',
  'sftp.conflict.action.skip': 'Skip',
  'sftp.conflict.action.resume': "Resume",
  ...
  'hostDetails.rdp.desc': 'Opens the remote desktop in the system RDP client (mstsc / Windows App / xfreerdp)',
  'hostDetails.rdp.port': 'RDP port',
  'hostDetails.rdp.port.desc': 'Remote Desktop service port (default 3389)',
  'rdp.launchFailed': 'Failed to launch the RDP client',
  'rdp.launchUnavailable': 'RDP launch is not available in this build',
  ...
  'hostDetails.proxyPanel.test': 'Test connection to {host}',
  'hostDetails.proxyPanel.testOk': 'Proxy reached the host in {ms} ms',
  'hostDetails.proxyPanel.testError.auth': 'The proxy rejected these credentials.',
  'hostDetails.proxyPanel.testError.timeout': 'The proxy did not answer in time.',
  'hostDetails.proxyPanel.testError.refused': 'The proxy refused the connection.',
  'hostDetails.proxyPanel.testError.dns': 'The proxy address could not be resolved.',
  'hostDetails.proxyPanel.testError.invalid': 'Fill in the proxy and host first.',
  'hostDetails.proxyPanel.testError.failed': 'Could not reach the host through this proxy.',
  ...
  'hostDetails.agent.pkcs11.title': 'Load smartcard (PKCS#11)',
  'hostDetails.agent.pkcs11.desc':
    'Load a PKCS#11 module into the system SSH agent (ssh-add -s). Uses OpenSC or vendor libraries you install — MagiesTerminal does not ship smartcard drivers.',
  'hostDetails.agent.pkcs11.pathPlaceholder': '/path/to/opensc-pkcs11.so',
  'hostDetails.agent.pkcs11.pinPlaceholder': 'Token PIN (optional; used once for ssh-add)',
  'hostDetails.agent.pkcs11.browse': 'Browse',
  'hostDetails.agent.pkcs11.load': 'Load into agent',
  'hostDetails.agent.pkcs11.unload': 'Unload',
  'hostDetails.agent.pkcs11.loaded': 'PKCS#11 module loaded into agent',
  'hostDetails.agent.pkcs11.unloaded': 'PKCS#11 module unloaded from agent',
  'hostDetails.agent.pkcs11.pathRequired': 'Choose a PKCS#11 module path',
  'hostDetails.agent.pkcs11.pickTitle': 'Select PKCS#11 module',
  'hostDetails.agent.pkcs11.pickUnavailable': 'File picker unavailable',
  'hostDetails.agent.pkcs11.error.platform_unsupported': 'PKCS#11 load is only supported on macOS and Linux',
  'hostDetails.agent.pkcs11.error.agent_unavailable': 'SSH agent is not available',
  'hostDetails.agent.pkcs11.error.module_not_readable': 'Cannot read the PKCS#11 module file',
  'hostDetails.agent.pkcs11.error.module_path_invalid': 'Invalid module path',
  'hostDetails.agent.pkcs11.error.ssh_add_failed': 'ssh-add failed — check module path, PIN, and agent',
  'hostDetails.agent.pkcs11.error.failed': 'Could not manage PKCS#11 module',
};
