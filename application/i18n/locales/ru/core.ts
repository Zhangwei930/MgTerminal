...
export const ruCoreMessages: Messages = {
  ...
  'settings.system.credentials.available': 'Доступно (можно шифровать секреты)',
  'settings.system.credentials.available.safeStorage': 'Доступно (системный Keychain)',
  'settings.system.credentials.available.localVault': 'Доступно (локальный encrypted vault без ACL Keychain)',
  'settings.system.credentials.unavailable': 'Недоступно (нельзя шифровать/расшифровывать)',
  ...
  'settings.system.credentials.selftest': 'Самопроверка',
  'settings.system.credentials.selftest.running': 'Выполняется самопроверка…',
  'settings.system.credentials.selftest.probe.unavailable': 'Мост шифрования учётных данных недоступен в этой среде.',
  'settings.system.credentials.selftest.probe.failed': 'Проверка шифрования не удалась — Keychain / локальное хранилище не может шифровать новые секреты.',
  'settings.system.credentials.selftest.probe.mismatch': 'Циклическая проверка вернула неверные данные — сохранённые секреты могут быть нечитаемы.',
  'settings.system.credentials.selftest.noIssues': 'Проверка пройдена. Все {count} сохранённых секретов расшифровываются корректно.',
  'settings.system.credentials.selftest.noSecrets': 'Проверка пройдена. Нет сохранённых секретов для проверки.',
  'settings.system.credentials.selftest.issues': '{count} сохранённых секретов не расшифровываются на этом устройстве. Введите и сохраните их заново:',
  'settings.system.credentials.repair.hint': 'Обновления могут ломать Keychain. Новые сборки автоматически используют локальный vault (enc:v2). Кнопка нужна только если что-то всё ещё не работает.',
  'settings.system.vaultUnlock.title': 'Разблокировка устройства для секретов vault',
  'settings.system.vaultUnlock.desc':
    'Требовать Touch ID (macOS) или локальный PIN перед загрузкой паролей и ключей в память. По умолчанию выкл. Это подтверждение присутствия на устройстве, не облачный passkey.',
  'settings.system.vaultUnlock.setupHint': 'Задайте PIN из 4–12 цифр как запасной вариант.',
  'settings.system.vaultUnlock.pinPlaceholder': 'PIN (только цифры)',
  'settings.system.vaultUnlock.pinConfirmPlaceholder': 'Подтвердите PIN',
  'settings.system.vaultUnlock.enable': 'Включить',
  'settings.system.vaultUnlock.enabledHint': 'После каждого запуска секреты остаются зашифрованными, пока вы не разблокируете vault.',
  'settings.system.vaultUnlock.enabledToast': 'Разблокировка устройства включена',
  'settings.system.vaultUnlock.disabledToast': 'Разблокировка устройства выключена',
  'settings.system.vaultUnlock.pinMismatch': 'PIN не совпадают',
  'settings.system.vaultUnlock.pinInvalid': 'PIN: 4–12 цифр',
  'vault.unlock.title': 'Разблокировать секреты vault',
  'vault.unlock.desc': 'Пройдите проверку, чтобы расшифровать пароли и ключи для этой сессии.',
  'vault.unlock.platformReason': 'Разблокировать секреты MagiesTerminal',
  'vault.unlock.usePlatform': 'Разблокировать через Touch ID',
  'vault.unlock.orPin': 'или PIN',
  'vault.unlock.pinPlaceholder': 'Введите PIN',
  'vault.unlock.unlockWithPin': 'Разблокировать PIN',
  'vault.unlock.pinIncorrect': 'Неверный PIN',
  'vault.unlock.cancelled': 'Аутентификация отменена',
  'vault.unlock.platformFailed': 'Ошибка разблокировки',
  'vault.unlock.misconfigured': 'Разблокировка включена, но нет PIN/платформы. Отключите в Настройки → Система.',
  'settings.system.credentials.repair.success': 'Безопасное хранилище снова доступно.',
  'settings.system.credentials.repair.partial': 'Попытка восстановления выполнена. API-ключи всё ещё можно сохранить через локальный vault; полностью закройте приложение (⌘Q) и откройте снова, чтобы повторить Keychain.',
  'settings.system.credentials.repair.failed': 'Восстановление не завершено, но сохранение API-ключей должно работать через локальный vault. При необходимости перезапустите приложение.',
  ...
  'settings.system.crashLogs.telemetryStats': 'Отправлено отчётов: {count} · последний {date}',
  'settings.system.crashLogs.telemetryNoneSent': 'Отчёты ещё не отправлялись.',
  ...
  'settings.sessionLogs.playCast': 'Воспроизвести запись .cast',
  'settings.sessionLogs.playCastHint': 'Воспроизведение записи в формате asciinema cast с временной шкалой и скоростью.',
  'castPlayer.title': 'Воспроизведение cast',
  'castPlayer.description': 'Воспроизводит запись asciinema cast v2. Файл читается локально и не покидает устройство.',
  'castPlayer.open': 'Открыть файл .cast',
  'castPlayer.noFile': 'Запись не загружена',
  'castPlayer.play': 'Воспроизвести',
  'castPlayer.pause': 'Пауза',
  'castPlayer.restart': 'Сначала',
  'castPlayer.seek': 'Перемотка',
  'castPlayer.skipped': 'Пропущено повреждённых строк: {count} — запись могла оборваться.',
  'castPlayer.error.empty': 'Файл пуст.',
  'castPlayer.error.header': 'Первая строка не является корректным заголовком cast.',
  'castPlayer.error.version': 'Поддерживаются только записи asciinema cast v2.',
  'castPlayer.error.dimensions': 'В заголовке нет корректных ширины и высоты.',
  ...
  'settings.application.contact': 'Связаться с нами',
  'settings.application.contact.subtitle': 'Напишите на hibake888@outlook.com',
  'settings.application.contact.copied': 'Адрес почты скопирован в буфер обмена',
  'settings.application.contact.copyFailed': 'Не удалось скопировать, запишите адрес вручную',
  ...
  'settings.appearance.themeColor.picker.desc': 'Основные палитры или поиск по полной библиотеке',
  'settings.appearance.themeColor.scope.core': 'Основные',
  'settings.appearance.themeColor.scope.all': 'Все',
  'settings.appearance.themeColor.search.placeholder': 'Поиск тем…',
  'settings.appearance.themeColor.search.empty': 'Нет тем по запросу',
  ...
  'settings.terminal.themeModal.search.placeholder': 'Поиск тем…',
  'settings.terminal.themeModal.search.empty': 'Нет тем, подходящих под запрос',
  'settings.terminal.themeModal.missingTheme.title': 'Тема отсутствует',
  'settings.terminal.themeModal.missingTheme.desc': 'Эта пользовательская тема больше недоступна. Выберите другую, чтобы заменить её.',
  ...
  'shortcutHelp.title': 'Горячие клавиши',
  'shortcutHelp.description': 'Нажмите {key} в любой момент, чтобы открыть этот список. Сочетания меняются в настройках.',
  'shortcutHelp.search': 'Поиск сочетаний…',
  'shortcutHelp.noResults': 'Нет сочетаний, соответствующих запросу.',
  'shortcutHelp.disabled': 'Горячие клавиши отключены в настройках.',
  ...
  'settings.shortcuts.binding.show-shortcuts': 'Показать горячие клавиши',
  ...
  'vault.nav.databases': 'Базы данных',

  'db.connections.new': 'Новое подключение',
  'db.connections.empty': 'Пока нет сохранённых подключений к базе данных.',
  'db.connections.selectHost': 'Выберите SSH-хост',
  'db.connections.selectEngine': 'Тип базы данных',
  'db.connections.label': 'Название подключения',
  'db.connections.database': 'Имя базы данных',
  'db.connections.username': 'Имя пользователя БД',
  'db.connections.password': 'Пароль БД',
  'db.connections.edit': 'Изменить подключение',
  'db.connections.useTunnel': 'Подключаться через SSH-туннель',
  'db.connections.tunnelHint': 'Включите, если база недоступна с этого компьютера; выберите сохранённый SSH-хост',
  'db.connections.directHint': 'Просто укажите адрес базы данных',
  'db.connections.remoteHost': 'Адрес хоста (со стороны SSH-сервера)',
  'db.connections.remotePort': 'Порт',
  'db.connections.passwordKeep': 'Оставьте пустым, чтобы сохранить текущий пароль',
  'db.connections.tls': 'Шифрование (TLS)',
  'db.connections.tlsDisable': 'Выключено',
  'db.connections.tlsRequire': 'Шифровать без проверки сертификата',
  'db.connections.tlsVerify': 'Шифровать и проверять сертификат',
  'db.connections.tlsHint': 'Прямое подключение по умолчанию не шифруется. Безопаснее всего проверка сертификата; средний вариант — для самоподписанных. Через SSH-туннель не требуется.',
  'db.connections.filePath': 'Файл базы данных',
  'db.connections.filePathHint': 'SQLite — это файл на этой машине: без хоста, порта и учётных данных, туннель не нужен.',
  'db.workspace.run': 'Выполнить',
  'db.workspace.cancel': 'Отмена',
  'db.workspace.connecting': 'Подключение…',
  'db.workspace.rowsAffected': 'Затронуто строк: {count}',
  'db.workspace.rowCount': 'Строк: {count}',
  'db.workspace.filterRows': 'Фильтр строк…',
  'db.workspace.prevPage': 'Назад',
  'db.workspace.nextPage': 'Вперёд',
  'db.workspace.pageRange': 'Строки {from}–{to}',
  'db.workspace.perPage': '{count} / стр.',
  ...
  'db.designer.title': 'Структура таблицы',
  'db.designer.newTable': 'Новая таблица',
  'db.designer.tableName': 'Имя таблицы',
  'db.designer.column': 'Столбец',
  'db.designer.type': 'Тип',
  'db.designer.nullable': 'NULL',
  'db.designer.primaryKey': 'Ключ',
  'db.designer.default': 'По умолчанию',
  'db.designer.addColumn': 'Добавить столбец',
  'db.designer.removeColumn': 'Удалить столбец',
  'db.designer.preview': 'Предпросмотр SQL',
  'db.designer.noChanges': 'Нет изменений для применения.',
  'db.designer.apply': 'Применить',
  'db.designer.applying': 'Применение…',
  'db.designer.cancel': 'Отмена',
  'db.schema.design': 'Структура таблицы',
  'db.schema.newTable': 'Новая таблица',
  'db.schema.dropTable': 'Удалить таблицу',
  'db.schema.dropTableConfirm': 'Удалить {name}? Это действие необратимо.',
  ...
  'db.export.json': 'JSON',
  'db.export.sql': 'SQL',
  'db.export.markdown': 'Markdown',
  'db.export.xml': 'XML',
  'db.export.html': 'HTML',
  'db.dump.export': 'Дамп базы',
  'db.dump.restore': 'Восстановить…',
  'db.dump.running': 'Чтение всех таблиц…',
  'db.dump.restoring': 'Выполнение файла…',
  'db.dump.chooseFile': 'Выберите файл .sql для выполнения',
  'db.dump.empty': 'В файле нет ни одной инструкции.',
  'db.dump.restoreConfirm': 'Выполнить {count} инструкций из файла в подключённой базе? Это необратимо.',
  'db.builder.open': 'Конструктор',
  'db.builder.title': 'Конструктор запросов',
  'db.builder.table': 'Таблица',
  'db.builder.selectTable': 'Выберите таблицу.',
  'db.builder.columns': 'Столбцы',
  'db.builder.allColumnsHint': 'Ничего не выбрано — значит все столбцы.',
  'db.builder.filters': 'Условия (все должны совпасть)',
  'db.builder.addFilter': 'Добавить условие',
  'db.builder.sort': 'Сортировка',
  'db.builder.addSort': 'Добавить сортировку',
  'db.builder.limit': 'Лимит строк',
  'db.builder.preview': 'SQL',
  'db.builder.apply': 'В редактор',
  'db.builder.close': 'Закрыть',
  'db.import.title': 'Импорт данных',
  'db.import.chooseFile': 'Выберите файл CSV или JSON…',
  'db.import.targetTable': 'Целевая таблица',
  'db.import.createTable': 'Создать таблицу по файлу',
  'db.import.preview': 'Предпросмотр',
  'db.import.rowsFound': 'Строк: {count}, столбцов: {columns}',
  'db.import.run': 'Импортировать',
  'db.import.running': 'Импорт…',
  'db.import.cancel': 'Отмена',
  'db.import.failed': 'Не удалось прочитать файл.',
  'db.schema.import': 'Импорт данных…',
  'db.explain.run': 'План',
  'db.explain.hint': 'Показать план выполнения, не выполняя запрос',
  'db.explain.selectOnly': 'План можно построить только для SELECT.',
  'db.history.title': 'История запросов',
  'db.history.filter': 'Поиск по истории…',
  'db.history.empty': 'Запросов пока нет.',
  'db.history.favourite': 'Сохранить запрос',
  'db.history.favouritesOnly': 'Только сохранённые',
  ...
  'db.er.close': 'Закрыть',
  'db.diff.title': 'Сравнение структуры',
  'db.diff.explain': 'Сравнивает другое подключение с «{source}» и создаёт скрипт приведения к нему.',
  'db.diff.target': 'Сравнить с',
  'db.diff.pick': 'Выберите подключение…',
  'db.diff.noCandidates': 'Сохраните ещё одно подключение для сравнения.',
  'db.diff.safety': 'Выполнимы только добавляющие операции. Всё, что может уничтожить данные — удаление, смена типа, ужесточение NULL — выводится закомментированным.',
  'db.diff.compare': 'Сравнить',
  'db.diff.reading': 'Чтение таблицы {done} из {total}…',
  'db.diff.close': 'Закрыть',
  ...
  'settings.update.installing': 'Перезапуск для установки обновления...',
  'settings.sessionRestore.title': 'Восстановление сессии',
  'settings.sessionRestore.restorePreviousSession': 'Восстанавливать вкладки и рабочие пространства',
  'settings.sessionRestore.restorePreviousSessionDesc': 'Открывать заново вкладки терминала и раскладки рабочих пространств из прошлой сессии приложения.',
  'settings.sessionRestore.restoreTerminalCwd': 'Восстанавливать рабочий каталог терминала',
  'settings.sessionRestore.restoreTerminalCwdDesc': 'При переподключении восстановленного терминала пытаться вернуться в последний известный каталог, не блокируя подключение.',
  'terminal.restore.placeholder.title': 'Восстановленная сессия',
  'terminal.restore.placeholder.desc': 'Этот терминал отключён. Переподключитесь, когда будете готовы начать новую оболочку для этой вкладки.',
  'terminal.restore.placeholder.reconnect': 'Переподключить',
  'terminal.restore.cwdLog': 'Восстановление рабочего каталога: {cwd}',

  // Side panel settings
  'settings.terminal.section.sidePanel': 'Боковая панель',
  'settings.terminal.sidePanel.autoOpen': 'Открывать боковую панель вместе с терминалом',
  'settings.terminal.sidePanel.autoOpen.desc': 'Автоматически открывать боковую панель при подключении терминала.',
  'settings.terminal.sidePanel.autoOpenPane': 'Панель по умолчанию',
  'settings.terminal.sidePanel.autoOpenPane.desc': 'Выберите, какая панель открывается первой.',
  'settings.terminal.sidePanel.pane.sftp': 'SFTP',
  'settings.terminal.sidePanel.pane.scripts': 'Скрипты',
  'settings.terminal.sidePanel.pane.history': 'История',
  'settings.terminal.sidePanel.pane.theme': 'Тема',
  'settings.terminal.sidePanel.pane.system': 'Система',
  'settings.terminal.sidePanel.pane.notes': 'Заметки',
  'settings.terminal.sidePanel.pane.ai': 'ИИ',

  // Connection safety
  'settings.terminal.connection.verifyHostKeys': 'Проверять ключи SSH-хостов',
  'settings.terminal.connection.verifyHostKeys.desc': 'Спрашивать перед подключением при новом или изменившемся ключе SSH-хоста. Отключайте только в доверенных частных сетях.',
  'settings.terminal.connection.verifyHostKeys.warning': 'Проверка ключей хостов отключена. SSH-подключения будут принимать любой ключ хоста без запроса, поэтому атаку «человек посередине» нельзя обнаружить. Оставляйте это отключённым только в доверенных частных сетях.',
  'settings.terminal.connection.sshAutoReconnectEnabled': 'Автоматически переподключать SSH-сессии',
  'settings.terminal.connection.sshAutoReconnectEnabled.desc': 'Если включено, установленные SSH-сессии при неожиданном обрыве переподключаются автоматически с экспоненциальной задержкой (от 5 до 60 с), останавливаясь после 10 неудач подряд.',

  // Tab hibernation
  'settings.terminal.rendering.hibernateHiddenTabs': 'Гибернация скрытых вкладок',
  'settings.terminal.rendering.hibernateHiddenTabs.desc': 'Освобождать рендерер терминала для невидимых вкладок для экономии памяти, сохраняя SSH-сессию подключённой. Пропускается во время передачи файлов.',
  'settings.terminal.rendering.hibernateHiddenTabsDelay': 'Задержка гибернации',
  'settings.terminal.rendering.hibernateHiddenTabsDelay.desc': 'Сколько вкладка должна оставаться вне экрана, прежде чем её рендерер будет освобождён (5–600 секунд).',
  'settings.terminal.rendering.hibernateSkipAltScreen': 'Не гибернировать полноэкранные приложения',
  'settings.terminal.rendering.hibernateSkipAltScreen.desc': 'Сохранять рендерер терминала, пока vim, htop или TUI-агенты владеют альтернативным экранным буфером.',
  'settings.terminal.rendering.hibernateKeepRendererCount': 'Сохранять скрытые рендереры',
  'settings.terminal.rendering.hibernateKeepRendererCount.desc': 'Сколько невидимых вкладок сохраняют рендерер (WebGL приостановлен) до полной гибернации.',
  'settings.terminal.rendering.hibernateReplayChunkBytes': 'Размер блока при пробуждении',
  'settings.terminal.rendering.hibernateReplayChunkBytes.desc': 'Сколько байт воспроизводится за кадр анимации при восстановлении гибернированного терминала (4–64 КБ).',
  'settings.terminal.rendering.hibernatePreferWasmSerialize': 'Предпочитать WASM-сериализацию',
  'settings.terminal.rendering.hibernatePreferWasmSerialize.desc': 'Использовать WASM-сериализацию терминала, когда она доступна; иначе используется JS-сериализатор.',

  'vault.groups.unnamed': 'Группа без названия',
  'vault.hosts.errors.nameRequired': 'Требуется имя хоста.',

  'settings.system.vaultUnlock.passkeySection': 'Passkey устройства',
  'settings.system.vaultUnlock.passkeyStatus.registered': 'Passkey зарегистрирован на этом устройстве',
  'settings.system.vaultUnlock.passkeyStatus.missing': 'Passkey ещё не зарегистрирован',
  'settings.system.vaultUnlock.passkeyStatus.checking': 'Проверка статуса passkey…',
  'settings.system.vaultUnlock.registerWebAuthn': 'Зарегистрировать passkey устройства',
  'settings.system.vaultUnlock.reRegisterWebAuthn': 'Заменить passkey устройства',
  'settings.system.vaultUnlock.clearWebAuthn': 'Удалить passkey',
  'settings.system.vaultUnlock.webauthnHint': 'Привязывает платформенный аутентификатор (Touch ID, Windows Hello или ключ безопасности) к этому устройству для разблокировки хранилища. Регистрация проверяется в основном процессе. Это не облачный multi-device passkey.',
  'settings.system.vaultUnlock.webauthnRegistered': 'Passkey устройства зарегистрирован для разблокировки',
  'settings.system.vaultUnlock.webauthnCleared': 'Passkey устройства удалён',
  'settings.system.vaultUnlock.webauthnUnavailable': 'Passkey на этом устройстве недоступен',
  'settings.system.vaultUnlock.webauthnFailed': 'Не удалось выполнить операцию passkey',
  'settings.system.vaultUnlock.webauthnBusy': 'Операция passkey уже выполняется',
  'settings.system.teamVault.title': 'Командное хранилище',
  'settings.system.teamVault.sectionDesc': 'Локальный обмен инвентарём команды с ролями и подписанным аудитом. Секреты не покидают это устройство.',
  'vault.unlock.useWebAuthn': 'Разблокировать passkey',
  'vault.unlock.webauthnHint': 'Используйте Touch ID, Windows Hello или ключ безопасности',
  'vault.unlock.platformHint': 'Подтвердите присутствие на этом устройстве',
  'vault.unlock.pinHint': 'Или введите локальный PIN',
  'vault.unlock.orOther': 'или',
  'vault.unlock.webauthnFailed': 'Не удалось разблокировать через passkey',
  'teamVault.title': 'Командное хранилище',
  'teamVault.desc': 'Обмен только метаданными хостов, роли и HMAC-аудит — без паролей и ключей.',
  'teamVault.signedAudit': 'Подписанный аудит',
  'teamVault.securityTitle': 'Локальный first, без облака',
  'teamVault.securityBody': 'Пакеты содержат только инвентарь (хост/порт/метки). Пароли, private key и agent-секреты не включаются.',
  'teamVault.tab.overview': 'Обзор',
  'teamVault.tab.setup': 'Создать',
  'teamVault.tab.share': 'Поделиться',
  'teamVault.tab.join': 'Присоединиться',
  'teamVault.tab.members': 'Участники',
  'teamVault.tab.audit': 'Аудит',
  'teamVault.createTitle': 'Создать локальную команду',
  'teamVault.createHint': 'Вы становитесь владельцем. Позже экспортируйте пакет для коллег.',
  'teamVault.createFootnote': 'Данные остаются на этом устройстве, пока вы не поделитесь пакетом.',
  'teamVault.create': 'Создать команду',
  'teamVault.created': 'Команда создана',
  'teamVault.goJoin': 'Есть приглашение? Присоединиться',
  'teamVault.joinTitle': 'Присоединиться к команде',
  'teamVault.joinHint': 'Вставьте строку пакета, которой поделился коллега.',
  'teamVault.join': 'Присоединиться',
  'teamVault.teamName': 'Название команды',
  'teamVault.teamNamePlaceholder': 'например, Ops-Production',
  'teamVault.displayName': 'Ваше имя',
  'teamVault.displayNamePlaceholder': 'Отображаемое имя',
  'teamVault.packageLabel': 'Строка пакета / JSON',
  'teamVault.packagePlaceholder': 'Вставьте magies-team-... или JSON пакета',
  'teamVault.stat.team': 'Команда',
  'teamVault.stat.members': 'Участники',
  'teamVault.stat.localHosts': 'Локальные хосты',
  'teamVault.stat.yourRole': 'Ваша роль',
  'teamVault.stat.exportable': 'К экспорту',
  'teamVault.export': 'Экспорт пакета',
  'teamVault.exportTitle': 'Поделиться инвентарём',
  'teamVault.exportHint': 'Скопируйте подписанный пакет. Секреты не включаются.',
  'teamVault.exportCopy': 'Копировать пакет',
  'teamVault.exportJson': 'Скачать JSON',
  'teamVault.exportSummary': '{hosts} хостов · {members} участников',
  'teamVault.exported': 'Пакет скопирован в буфер обмена',
  'teamVault.exportedClipboardFailed': 'Пакет готов, но буфер обмена недоступен — скопируйте вручную',
  'teamVault.shareCopied': 'Строка пакета скопирована',
  'teamVault.copyAgain': 'Копировать снова',
  'teamVault.jsonDownloaded': 'JSON-пакет скачан',
  'teamVault.importTitle': 'Импорт / обновление пакета',
  'teamVault.importHint': 'Обновите локальную политику и инвентарь из пакета коллеги.',
  'teamVault.importUpdate': 'Импортировать обновление',
  'teamVault.importForbidden': 'Недостаточно прав для импорта',
  'teamVault.imported': 'Импортировано: {count} хостов в инвентаре',
  'teamVault.importFailed': 'Импорт не удался: {error}',
  'teamVault.leave': 'Покинуть команду',
  'teamVault.leaveConfirm': 'Удалить локальную политику команды и аудит? Секреты Vault не затрагиваются.',
  'teamVault.left': 'Локальные данные команды удалены',
  'teamVault.noTeam': 'Команда не настроена',
  'teamVault.forbidden': 'Недостаточно прав',
  'teamVault.copyFailed': 'Не удалось скопировать',
  'teamVault.error.teamNameRequired': 'Укажите название команды',
  'teamVault.error.displayNameRequired': 'Укажите отображаемое имя',
  'teamVault.error.packageEmpty': 'Вставьте пакет',
  'teamVault.role.owner': 'Владелец',
  'teamVault.role.editor': 'Редактор',
  'teamVault.role.viewer': 'Наблюдатель',
  'teamVault.roleUpdated': 'Роль обновлена',
  'teamVault.roster': 'Состав',
  'teamVault.rosterHint': 'Роли хранятся локально в политике команды.',
  'teamVault.rosterReadOnly': 'Только владелец может менять роли.',
  'teamVault.you': 'вы',
  'teamVault.auditTitle': 'Журнал аудита',
  'teamVault.auditHint': 'События с HMAC-подписью. Очистка необратима.',
  'teamVault.auditEmpty': 'Событий аудита пока нет',
  'teamVault.auditCleared': 'Аудит очищен',
  'teamVault.auditCopied': 'Аудит скопирован (текст)',
  'teamVault.auditCopiedNdjson': 'Аудит скопирован (NDJSON)',
  'teamVault.audit.refresh': 'Обновить',
  'teamVault.audit.copyText': 'Копировать текст',
  'teamVault.audit.copyNdjson': 'Копировать NDJSON',
  'teamVault.audit.clear': 'Очистить',
  'teamVault.audit.clearConfirm': 'Очистить весь локальный аудит команды?',
  'teamVault.audit.col.time': 'Время',
  'teamVault.audit.col.type': 'Тип',
  'teamVault.audit.col.detail': 'Детали',
  'teamVault.audit.col.sig': 'Подпись',
  'teamVault.audit.sig.verified': 'Подпись проверена',
  'teamVault.audit.sig.invalid': 'Подпись не совпадает — запись изменена.',
  'teamVault.audit.sig.unsigned': 'Записано до появления ключа аудита команды.',
  'teamVault.audit.sig.unverifiable': 'Подписано, но на этом устройстве нет ключа аудита для проверки.',
  'teamVault.audit.type.team_created': 'Команда создана',
  'teamVault.audit.type.member_joined': 'Участник присоединился',
  ...
  'settings.application.whatsNew.kind.features': 'Возможности',
  'settings.application.whatsNew.kind.fixes': 'Исправления',
  'settings.application.whatsNew.kind.improvements': 'Улучшения',
  'settings.application.whatsNew.kind.security': 'Безопасность',
  'settings.application.whatsNew.kind.breaking': 'Несовместимые',
  'settings.application.whatsNew.kind.platform': 'Платформа',
  'settings.application.whatsNew.kind.other': 'Прочее',
  'settings.application.whatsNew.clearFilter': 'Показать все',
