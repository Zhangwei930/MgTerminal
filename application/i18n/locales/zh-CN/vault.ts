...
export const zhCNVaultMessages: Messages = {
  ...
  'hostDetails.rdp.desc': '在系统 RDP 客户端（mstsc / Windows App / xfreerdp）中打开远程桌面',
  'hostDetails.rdp.port': 'RDP 端口',
  'hostDetails.rdp.port.desc': '远程桌面服务端口（默认 3389）',
  'rdp.launchFailed': '启动 RDP 客户端失败',
  'rdp.launchUnavailable': '当前构建不支持 RDP 启动',
  ...
  'hostDetails.preferPostQuantumKex': '优先后量子 KEX',
  'hostDetails.preferPostQuantumKex.desc':
    '优先协商混合后量子密钥交换。内置协议栈使用 mlkem768x25519-sha256，并在服务端不支持时回退经典 KEX。启用系统 OpenSSH 时还可协商 sntrup761 混合算法（视平台 ssh 支持情况）。',
  'hostDetails.useSystemOpenSsh': '使用系统 OpenSSH 传输',
  'hostDetails.useSystemOpenSsh.desc':
    '通过平台 ssh 可执行文件建立连接，而非 MagiesTerminal 内置 ssh2。GSSAPI/Kerberos 需要此路径。跳板主机经 OpenSSH ProxyJump 支持；HTTP/SOCKS 代理由应用内回环中继支持（与跳板不可同时使用）。',
  ...
  'terminal.paste.dangerous.title': '危险粘贴',
  'terminal.paste.dangerous.message': '这段粘贴内容看起来很危险，可能损坏远程系统。\n\n匹配：{pattern}\n内容：{command}\n\n仍要发送吗？',
  'terminal.paste.dangerous.confirm': '仍然粘贴',
  'terminal.toolbar.broadcastEnable': '启用广播模式',
  'terminal.toolbar.broadcastDisable': '关闭广播模式',
  'terminal.toolbar.broadcastTargets': '广播目标',
  'terminal.toolbar.broadcastTargetCount': '{count} 个目标',
  'terminal.toolbar.broadcastScope.workspace': '当前工作区',
  'terminal.toolbar.broadcastScope.selected': '选定会话',
  'terminal.toolbar.broadcastScope.group': '相同主机分组',
  'terminal.toolbar.broadcastScope.window': '当前窗口',
  'terminal.toolbar.broadcastSelectSessions': '包含会话',
  'terminal.toolbar.broadcastExcludeSessions': '排除会话',
  'terminal.toolbar.broadcastNoSessions': '当前工作区没有会话',
  ...
  'terminal.composeBar.broadcasting': '正在广播到目标会话',
  ...
  'hostDetails.agent.pkcs11.title': '加载智能卡（PKCS#11）',
  'hostDetails.agent.pkcs11.desc':
    '通过 ssh-add -s 将 PKCS#11 模块载入系统 SSH agent。需自行安装 OpenSC 或厂商库 — MagiesTerminal 不附带驱动。',
  'hostDetails.agent.pkcs11.pathPlaceholder': '/path/to/opensc-pkcs11.so',
  'hostDetails.agent.pkcs11.pinPlaceholder': '令牌 PIN（可选，仅用于本次 ssh-add）',
  'hostDetails.agent.pkcs11.browse': '浏览',
  'hostDetails.agent.pkcs11.load': '加载到 agent',
  'hostDetails.agent.pkcs11.unload': '卸载',
  'hostDetails.agent.pkcs11.loaded': '已将 PKCS#11 模块加载到 agent',
  'hostDetails.agent.pkcs11.unloaded': '已从 agent 卸载 PKCS#11 模块',
  'hostDetails.agent.pkcs11.pathRequired': '请选择 PKCS#11 模块路径',
  'hostDetails.agent.pkcs11.pickTitle': '选择 PKCS#11 模块',
  'hostDetails.agent.pkcs11.pickUnavailable': '无法使用文件选择器',
  'hostDetails.agent.pkcs11.error.platform_unsupported': '仅 macOS / Linux 支持 PKCS#11 加载',
  'hostDetails.agent.pkcs11.error.agent_unavailable': 'SSH agent 不可用',
  'hostDetails.agent.pkcs11.error.module_not_readable': '无法读取 PKCS#11 模块文件',
  'hostDetails.agent.pkcs11.error.module_path_invalid': '模块路径无效',
  'hostDetails.agent.pkcs11.error.ssh_add_failed': 'ssh-add 失败 — 请检查模块路径、PIN 与 agent',
  'hostDetails.agent.pkcs11.error.failed': '无法管理 PKCS#11 模块',
};
