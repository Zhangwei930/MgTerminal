...
export const enCoreMessages: Messages = {
  ...
  'settings.system.vaultUnlock.desc':
    'Require Touch ID (macOS) or a local PIN before passwords and private keys are loaded into memory. Default off. Proves presence on this device — not a cloud passkey.',
  'settings.system.vaultUnlock.setupHint': 'Choose a 4–12 digit PIN as fallback when platform auth is unavailable.',
  ...
  'vault.unlock.misconfigured': 'Unlock is enabled but no PIN or platform auth is available. Disable the setting in Settings → System.',
