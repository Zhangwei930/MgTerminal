...
test("parseSshDeepLink rejects links containing credentials", () => {
  assert.equal(parseSshDeepLink("ssh://alice:secret@example.com"), null);
  assert.equal(parseSshDeepLink("ssh://alice:p%40ss@example.com:2200"), null);
});

test("parseSshDeepLink accepts links without passwords", () => {
