...
export const enVaultMessages: Messages = {
  ...
  'vault.dataSources.desc':
    'Pull host inventory from a local JSON file or HTTP(S) endpoint. Credentials stay in MagiesTerminal Keychain — inventory must not include secrets.',
  'vault.dataSources.count': '{count} inventory source(s)',
  'vault.dataSources.add': 'Add source',
  'vault.dataSources.addAndSync': 'Add & sync',
  'vault.dataSources.empty': 'No JSON inventory sources yet. Add a file or URL to sync hosts from CMDB / Ansible inventory / custom API.',
  ...
  'vault.dataSources.pickFileTitle': 'Select host inventory JSON',
  'vault.dataSources.type.file': 'JSON file',
  'vault.dataSources.type.fileDesc': 'Local file path, re-sync on demand.',
  'vault.dataSources.type.http': 'HTTP(S)',
  'vault.dataSources.type.httpDesc': 'Fetch inventory from a URL (API Bridge style).',
  ...
  'vault.dataSources.secretsNote':
    'Inventory JSON may only include host metadata (id, hostname, port, username, tags…). Passwords and private keys are rejected.',
