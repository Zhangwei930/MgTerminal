...
export const enTerminalMessages: Messages = {
  ...
  'terminal.follow.lan.joinToggle': 'Join a LAN invite…',
  'terminal.follow.lan.joinPlaceholder': 'Paste magies-follow:1:… invite',
  'terminal.follow.lan.join': 'Join LAN session',
