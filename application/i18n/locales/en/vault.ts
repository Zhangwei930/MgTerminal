...
export const enVaultMessages: Messages = {
  ...
  'vault.dataSources.type.fileDesc': 'JSON or Ansible INI path; re-sync on demand.',
  'vault.dataSources.type.http': 'HTTP(S)',
  'vault.dataSources.type.httpDesc': 'Fetch JSON or Ansible INI from a URL (API Bridge style).',
