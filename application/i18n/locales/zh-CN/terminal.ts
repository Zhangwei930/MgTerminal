...
export const zhCNTerminalMessages: Messages = {
  ...
  'terminal.toolbar.aiAssist': "AI 辅助",
  'terminal.toolbar.aiExplain': "用 AI 解释选区",
  'terminal.selection.explainDraft': "请解释这段终端输出，并给出修复或下一步建议：",
  'terminal.menu.explainSelectionWithAI': "用 AI 解释选区",
  ...
  'terminal.follow.toolbar': '本地跟随',
  'terminal.follow.title': '本地跟随模式',
  'terminal.follow.desc':
    '在同一会话流上打开本地观看窗口。同一时间仅一人可输入；观看者需获授权后才能控制。',
  'terminal.follow.start': '开始跟随',
  'terminal.follow.stop': '停止跟随',
  'terminal.follow.openViewer': '打开本地观看窗口',
  'terminal.follow.requestControl': '请求控制',
  'terminal.follow.grantTo': '授权给 {name}',
  'terminal.follow.revoke': '收回控制（还给主机）',
  'terminal.follow.peers': '{count} 个对端',
  'terminal.follow.pending': '{count} 个请求',
  'terminal.follow.role.controller': '控制中',
  'terminal.follow.role.viewer': '观看中',
  'terminal.follow.viewerTitle': '跟随 · {label}',
  'terminal.follow.joining': '正在加入会话…',
  'terminal.follow.toast.started': '已开启跟随模式',
  'terminal.follow.toast.stopped': '已停止跟随模式',
  'terminal.follow.toast.controlRequested': '已请求控制 — 需主机授权',
  'terminal.follow.toast.granted': '已授予控制权',
  'terminal.follow.toast.revoked': '控制权已交还主机',
  'terminal.follow.toast.inputDenied': '当前为观看模式 — 请先请求控制',
  'terminal.follow.error.unavailable': '当前环境不可用跟随模式',
  'terminal.follow.error.startFailed': '无法开启跟随模式',
  'terminal.follow.error.joinFailed': '无法加入跟随会话',
  'terminal.follow.error.openViewerFailed': '无法打开观看窗口',
  'terminal.follow.error.requestFailed': '无法请求控制',
  'terminal.follow.error.grantFailed': '无法授予控制',
  'terminal.follow.error.revokeFailed': '无法收回控制',
  'terminal.follow.lan.tab': '局域网',
  'terminal.follow.lan.desc': '同网段观看者通过短时 TCP 邀请连接。无需云账号。',
  'terminal.follow.lan.create': '创建局域网邀请',
  'terminal.follow.lan.inviteTitle': '局域网邀请',
  'terminal.follow.lan.code': '口令',
  'terminal.follow.lan.copyShare': '复制邀请串',
  'terminal.follow.lan.copied': '邀请已复制',
  'terminal.follow.lan.copyFailed': '无法复制邀请',
  'terminal.follow.lan.created': '局域网邀请已就绪 — 发给同网段观看者',
  'terminal.follow.lan.joinToggle': '加入邀请…',
  'terminal.follow.lan.joinPlaceholder': '粘贴 magies-follow:1:… 或 :2:… 邀请串',
  'terminal.follow.lan.join': '加入会话',
  'terminal.follow.lan.joinEmpty': '请先粘贴邀请串',
  'terminal.follow.lan.viewerTitle': '局域网跟随 · {label}',
  'terminal.follow.lan.connecting': '正在通过局域网连接…',
  'terminal.follow.lan.disconnected': '局域网跟随已断开',
  'terminal.follow.lan.error.create': '无法创建局域网邀请',
  'terminal.follow.lan.error.join': '无法加入局域网邀请',
  'terminal.follow.wan.tab': '公网 / 中继',
  'terminal.follow.wan.desc': '主机与观看者主动连出到 TCP 中继（利于 NAT）。测试可用内置本机中继；公网请在 VPS 运行 scripts/follow-relay.cjs。',
  'terminal.follow.wan.create': '创建 WAN 邀请',
  'terminal.follow.wan.created': 'WAN 跟随邀请已就绪',
  'terminal.follow.wan.inviteTitle': 'WAN 跟随邀请',
  'terminal.follow.wan.customRelay': '使用自定义中继主机',
  'terminal.follow.wan.customRelayHint': '不勾选时，MagiesTerminal 会在本机启动内嵌中继。',
  'terminal.follow.wan.relayHostPlaceholder': 'relay.example.com',
  'terminal.follow.wan.localRelayBadge': '本机中继',
  'terminal.follow.wan.shareHint': '分享邀请串。观看者需能访问中继 host:port（必要时做端口转发）。',
  'terminal.follow.wan.error.create': '无法创建 WAN 邀请',
  'terminal.follow.audit.show': '显示审计日志',
  'terminal.follow.audit.hide': '隐藏审计日志',
  'terminal.follow.audit.title': '协作审计',
  'terminal.follow.audit.refresh': '刷新',
  ...
  'terminal.follow.audit.copiedNdjson': '已复制审计 NDJSON',
  'terminal.follow.audit.copyFailed': '无法复制审计日志',
  'terminal.follow.audit.clear': '清除本机历史',
  'terminal.follow.audit.cleared': '审计历史已清除',
  'terminal.follow.audit.clearFailed': '无法清除审计历史',
  'terminal.follow.audit.type.follow_started': '开始 Follow',
  'terminal.follow.audit.type.follow_stopped': '结束 Follow',
  'terminal.follow.audit.type.peer_joined': '对端加入',
  'terminal.follow.audit.type.peer_left': '对端离开',
  'terminal.follow.audit.type.control_requested': '请求控制',
  'terminal.follow.audit.type.control_granted': '授予控制',
  'terminal.follow.audit.type.control_revoked': '收回控制',
  'terminal.follow.audit.type.control_denied': '拒绝控制',
  'terminal.follow.audit.type.input_denied': '输入被拒绝',

  'terminal.hex.enable': '显示 Hex 诊断',
  ...
  'terminal.hex.clear': '清空',
  'terminal.hex.close': '关闭 Hex 面板',
  'terminal.hex.copied': '已复制 Hex 转储',
  'terminal.hex.copyFailed': '复制 Hex 转储失败',
  ...
  'terminal.progress.autoReconnectGaveUp': '连续 {attempts} 次自动重连失败，已停止。按 Enter 手动重连。',
  ...
  'settings.terminal.themeModal.search.placeholder': '搜索主题…',
  'settings.terminal.themeModal.search.empty': '没有匹配的主题',
  'settings.terminal.themeModal.missingTheme.title': '主题已丢失',
  'settings.terminal.themeModal.missingTheme.desc': '该自定义主题已不可用，请选择其他主题替换。',
  ...
  'settings.terminal.connection.sshAutoReconnectEnabled.desc': '打开后，已连上的 SSH 会话意外断开时会自动重连：从 5 秒起按指数退避（最长 60 秒），连续失败 10 次后停止。',
  ...
  'shortcutHelp.description': '随时按 {key} 打开此列表。快捷键可在设置中修改。',
  'shortcutHelp.search': '搜索快捷键…',
  'shortcutHelp.noResults': '没有匹配的快捷键。',
  'shortcutHelp.disabled': '快捷键已在设置中关闭。',
  ...
  'settings.shortcuts.binding.show-shortcuts': '显示快捷键',
  ...
  'hostDetails.proxyPanel.test': '测试连接到 {host}',
  'hostDetails.proxyPanel.testOk': '代理已连通主机，耗时 {ms} 毫秒',
  'hostDetails.proxyPanel.testError.auth': '代理拒绝了该凭据。',
  'hostDetails.proxyPanel.testError.timeout': '代理未在超时前响应。',
  'hostDetails.proxyPanel.testError.refused': '代理拒绝了连接。',
  'hostDetails.proxyPanel.testError.dns': '无法解析代理地址。',
  'hostDetails.proxyPanel.testError.invalid': '请先填写代理和主机。',
  'hostDetails.proxyPanel.testError.failed': '无法通过该代理连接到主机。',
  ...
  'keychain.import.fido2Unsupported': '这是 FIDO2 安全密钥（sk-*），无法直接导入使用。请先用 ssh-add 将其加入 ssh-agent，连接时会自动通过 agent 认证。',
  ...
  'health.status.host-key-untrusted': '主机密钥未验证——先连接一次以确认并信任它',
