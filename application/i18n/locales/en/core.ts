...
export const enCoreMessages: Messages = {
  ...
  'settings.system.credentials.available': 'Available (can encrypt secrets)',
  'settings.system.credentials.available.safeStorage': 'Available (OS keychain)',
  'settings.system.credentials.available.localVault': 'Available (local encrypted vault; no Keychain ACL)',
  'settings.system.credentials.unavailable': 'Unavailable (cannot encrypt or decrypt credentials)',
  ...
  'settings.system.credentials.repair.hint': 'App updates can break Keychain access. Newer builds automatically fall back to a local encrypted vault (enc:v2). Use Fix Keychain only if something still fails.',
  'settings.system.vaultUnlock.title': 'Device unlock for vault secrets',
  'settings.system.vaultUnlock.desc':
    'Require Touch ID (macOS), a device passkey, or a local PIN before passwords and private keys are loaded into memory. Default off. Proves presence on this device — not a portable cloud identity.',
  'settings.system.vaultUnlock.setupHint': 'Choose a 4–12 digit PIN as fallback when platform auth is unavailable. You can register a device passkey after enabling.',
  'settings.system.vaultUnlock.pinPlaceholder': 'PIN (digits only)',
  'settings.system.vaultUnlock.pinConfirmPlaceholder': 'Confirm PIN',
  'settings.system.vaultUnlock.enable': 'Enable',
  'settings.system.vaultUnlock.enabledHint': 'Vault secrets stay encrypted until you unlock after each app start.',
  'settings.system.vaultUnlock.enabledToast': 'Device unlock enabled',
  'settings.system.vaultUnlock.disabledToast': 'Device unlock disabled',
  'settings.system.vaultUnlock.pinMismatch': 'PINs do not match',
  'settings.system.vaultUnlock.pinInvalid': 'PIN must be 4–12 digits',
  'settings.system.vaultUnlock.passkeySection': 'Device passkey',
  'settings.system.vaultUnlock.passkeyStatus.registered': 'Passkey registered on this device',
  'settings.system.vaultUnlock.passkeyStatus.missing': 'No passkey registered yet',
  'settings.system.vaultUnlock.passkeyStatus.checking': 'Checking passkey status…',
  'settings.system.vaultUnlock.registerWebAuthn': 'Register device passkey',
  'settings.system.vaultUnlock.reRegisterWebAuthn': 'Replace device passkey',
  'settings.system.vaultUnlock.clearWebAuthn': 'Remove passkey',
  'settings.system.vaultUnlock.webauthnHint':
    'Binds a platform authenticator (Touch ID, Windows Hello, or a security key) to this device for vault unlock. Registration is verified in the main process. This is not a multi-device cloud passkey.',
  'settings.system.vaultUnlock.webauthnRegistered': 'Device passkey registered for vault unlock',
  'settings.system.vaultUnlock.webauthnCleared': 'Device passkey removed',
  'settings.system.vaultUnlock.webauthnUnavailable': 'Passkeys are not available in this environment',
  'settings.system.vaultUnlock.webauthnFailed': 'Passkey registration failed',
  'settings.system.vaultUnlock.webauthnBusy': 'Waiting for authenticator…',
  'settings.system.teamVault.title': 'Team vault',
  'settings.system.teamVault.sectionDesc': 'Local-first team inventory sharing with roles and signed audit. Secrets never leave this device.',
  'vault.unlock.title': 'Unlock vault secrets',
  'vault.unlock.desc': 'Authenticate to decrypt passwords and private keys for this session.',
  'vault.unlock.platformReason': 'Unlock MagiesTerminal vault secrets',
  'vault.unlock.usePlatform': 'Unlock with Touch ID',
  'vault.unlock.useWebAuthn': 'Unlock with passkey',
  'vault.unlock.webauthnHint': 'Use the passkey registered on this device',
  'vault.unlock.platformHint': 'Use Touch ID or system biometrics',
  'vault.unlock.pinHint': 'Use your local PIN fallback',
  'vault.unlock.orPin': 'or use PIN',
  'vault.unlock.orOther': 'Other methods',
  'vault.unlock.pinPlaceholder': 'Enter PIN',
  'vault.unlock.unlockWithPin': 'Unlock with PIN',
  'vault.unlock.pinIncorrect': 'Incorrect PIN',
  'vault.unlock.cancelled': 'Authentication cancelled',
  'vault.unlock.platformFailed': 'Platform unlock failed',
  'vault.unlock.webauthnFailed': 'Passkey unlock failed',
  'vault.unlock.misconfigured': 'Unlock is enabled but no PIN, passkey, or platform auth is available. Disable the setting in Settings → System.',
  'teamVault.title': 'Team vault',
  'teamVault.desc': 'Share host inventory metadata with teammates. Credentials never leave this device. Roles control who can export or import packages; audit events can be HMAC-signed with the team key.',
  'teamVault.signedAudit': 'Signed audit',
  'teamVault.securityTitle': 'Secrets stay local',
  'teamVault.securityBody': 'Exported packages contain host labels, hostnames, ports, and identity hints only — never passwords or private keys.',
  'teamVault.tab.overview': 'Overview',
  'teamVault.tab.setup': 'Create',
  'teamVault.tab.share': 'Share',
  'teamVault.tab.join': 'Join',
  'teamVault.tab.members': 'Members',
  'teamVault.tab.audit': 'Audit',
  'teamVault.createTitle': 'Create a local team',
  'teamVault.createHint': 'You become the owner. Share a package later so others can join as viewers (or elevate them as owner).',
  'teamVault.createFootnote': 'Team policy is stored on this device. The audit key is generated locally for HMAC signatures — keep team packages private.',
  'teamVault.create': 'Create team',
  'teamVault.created': 'Team created',
  'teamVault.goJoin': 'I have a package to join',
  'teamVault.joinTitle': 'Join with a team package',
  'teamVault.joinHint': 'Paste a magies-team share string or JSON package. New members join as viewers unless already listed.',
  'teamVault.join': 'Join team',
  'teamVault.teamName': 'Team name',
  'teamVault.teamNamePlaceholder': 'e.g. Production Ops',
  'teamVault.displayName': 'Your display name',
  'teamVault.displayNamePlaceholder': 'e.g. Ada',
  'teamVault.packageLabel': 'Team package',
  'teamVault.packagePlaceholder': 'magies-team:1:… or paste JSON',
  'teamVault.stat.team': 'Team',
  'teamVault.stat.members': 'Members',
  'teamVault.stat.localHosts': 'Local hosts',
  'teamVault.stat.yourRole': 'Your role',
  'teamVault.stat.exportable': 'Available for export',
  'teamVault.export': 'Export package',
  'teamVault.exportTitle': 'Export inventory package',
  'teamVault.exportHint': 'Copy a share string or download JSON. Only metadata is included.',
  'teamVault.exportCopy': 'Copy share string',
  'teamVault.exportJson': 'Download JSON',
  'teamVault.exportSummary': '{hosts} host(s) · {members} member(s) in package',
  'teamVault.exported': 'Team package copied (metadata only)',
  'teamVault.exportedClipboardFailed': 'Package ready — copy failed; use the preview below',
  'teamVault.shareCopied': 'Share string copied',
  'teamVault.copyAgain': 'Copy again',
  'teamVault.jsonDownloaded': 'JSON package downloaded',
  'teamVault.importTitle': 'Import / update package',
  'teamVault.importHint': 'Paste an updated package from a teammate to refresh membership and inventory metadata.',
  'teamVault.importUpdate': 'Import package',
  'teamVault.importForbidden': 'Your role cannot import packages. Ask an owner or editor to share updates.',
  'teamVault.imported': 'Joined team · {count} host(s) in package',
  'teamVault.importFailed': 'Import failed ({error})',
  'teamVault.leave': 'Leave team',
  'teamVault.leaveConfirm': 'Leave this team on this device? Local hosts are not deleted.',
  'teamVault.left': 'Left team',
  'teamVault.noTeam': 'No team yet',
  'teamVault.forbidden': 'Not allowed for your role',
  'teamVault.copyFailed': 'Copy failed',
  'teamVault.error.teamNameRequired': 'Enter a team name',
  'teamVault.error.displayNameRequired': 'Enter your display name',
  'teamVault.error.packageEmpty': 'Paste a team package first',
  'teamVault.role.owner': 'Owner',
  'teamVault.role.editor': 'Editor',
  'teamVault.role.viewer': 'Viewer',
  'teamVault.roleUpdated': 'Role updated',
  'teamVault.roster': 'Member roster',
  'teamVault.rosterHint': 'Owners can change roles for others. Join packages add viewers by default.',
  'teamVault.rosterReadOnly': 'Only owners can change member roles.',
  'teamVault.you': 'You',
  'teamVault.auditTitle': 'Signed collaboration audit',
  'teamVault.auditHint': 'Local ring of team events. When a team audit key exists, events are HMAC-SHA256 signed.',
  'teamVault.auditEmpty': 'No audit events yet',
  'teamVault.auditCleared': 'Audit cleared',
  'teamVault.auditCopied': 'Audit copied as text',
  'teamVault.auditCopiedNdjson': 'Audit copied as NDJSON',
  'teamVault.audit.refresh': 'Refresh',
  'teamVault.audit.copyText': 'Copy text',
  'teamVault.audit.copyNdjson': 'Copy NDJSON',
  'teamVault.audit.clear': 'Clear',
  'teamVault.audit.clearConfirm': 'Clear local team audit history on this device?',
  'teamVault.audit.col.time': 'Time',
  'teamVault.audit.col.type': 'Event',
  'teamVault.audit.col.detail': 'Detail',
  'teamVault.audit.col.sig': 'Sig',
  'teamVault.audit.sig.verified': 'Signature verified',
  'teamVault.audit.sig.invalid': 'Signature does not match — this entry was altered.',
  'teamVault.audit.sig.unsigned': 'Recorded before a team audit key existed.',
  'teamVault.audit.sig.unverifiable': 'Signed, but no audit key on this device to check it.',
  'teamVault.audit.type.team_created': 'Team created',
  'teamVault.audit.type.member_joined': 'Member joined',
  ...
  'settings.sessionLogs.playCast': 'Play a .cast recording',
  'settings.sessionLogs.playCastHint': 'Replay a recording saved in asciinema cast format, with a timeline and playback speed.',
  'castPlayer.title': 'Cast playback',
  'castPlayer.description': 'Replays an asciinema cast v2 recording. The file is read locally and never leaves this device.',
  'castPlayer.open': 'Open .cast file',
  'castPlayer.noFile': 'No recording loaded',
  'castPlayer.play': 'Play',
  'castPlayer.pause': 'Pause',
  'castPlayer.restart': 'Restart',
  'castPlayer.seek': 'Seek',
  'castPlayer.skipped': '{count} damaged line(s) skipped — the recording may have been cut short.',
  'castPlayer.error.empty': 'The file is empty.',
  'castPlayer.error.header': 'The first line is not a valid cast header.',
  'castPlayer.error.version': 'Only asciinema cast v2 recordings are supported.',
  'castPlayer.error.dimensions': 'The header is missing a valid width and height.',
  ...
  'settings.application.contact': 'Contact us',
  'settings.application.contact.subtitle': 'Email hibake888@outlook.com',
  'settings.application.contact.copied': 'Email address copied to clipboard',
  'settings.application.contact.copyFailed': 'Copy failed, please note the address manually',
  'settings.application.whatsNew': "What's new",
  'settings.application.whatsNew.subtitle': 'Show release notes',
  'settings.application.whatsNew.summary': '{versions} versions · {changes} changes',
  'settings.application.whatsNew.inLatest': 'in this release',
  'settings.application.whatsNew.kind.features': 'Features',
  'settings.application.whatsNew.kind.fixes': 'Fixes',
  'settings.application.whatsNew.kind.improvements': 'Improvements',
  'settings.application.whatsNew.kind.security': 'Security',
  'settings.application.whatsNew.kind.breaking': 'Breaking',
  'settings.application.whatsNew.kind.platform': 'Platform',
  'settings.application.whatsNew.kind.other': 'Other',
  'settings.application.whatsNew.clearFilter': 'Show all',
  'settings.application.whatsNew.latest': 'Latest',
  'settings.application.whatsNew.changeCount': '{count} changes',
  'settings.application.whatsNew.empty': 'No release notes are available in this build.',
  'settings.application.whatsNew.footer': 'Release notes follow your current interface language.',
  ...
  'settings.appearance.themeColor.picker.desc': 'Browse curated core palettes or search the full library',
  'settings.appearance.themeColor.scope.core': 'Core',
  'settings.appearance.themeColor.scope.all': 'All',
  'settings.appearance.themeColor.search.placeholder': 'Search themes…',
  'settings.appearance.themeColor.search.empty': 'No themes match your search',
  ...
  'settings.terminal.themeModal.search.placeholder': 'Search themes…',
  'settings.terminal.themeModal.search.empty': 'No themes match your search',
  'settings.terminal.themeModal.missingTheme.title': 'Missing theme',
  'settings.terminal.themeModal.missingTheme.desc': 'This custom theme is no longer available. Pick another theme to replace it.',
  ...
  'shortcutHelp.description': 'Press {key} any time to open this list. Shortcuts can be changed in Settings.',
  'shortcutHelp.search': 'Search shortcuts…',
  'shortcutHelp.noResults': 'No shortcut matches your search.',
  'shortcutHelp.disabled': 'Keyboard shortcuts are turned off in Settings.',
  ...
  'vault.nav.logs': 'Logs',
  'vault.nav.databases': 'Databases',

  'db.connections.new': 'New Connection',
  'db.connections.empty': 'No saved database connections yet.',
  'db.connections.selectHost': 'Select SSH host',
  'db.connections.selectEngine': 'Database type',
  'db.connections.label': 'Connection name',
  'db.connections.database': 'Database name',
  'db.connections.username': 'Database username',
  'db.connections.password': 'Database password',
  'db.connections.edit': 'Edit connection',
  'db.connections.useTunnel': 'Connect through an SSH tunnel',
  'db.connections.tunnelHint': 'Tick when the database is not reachable from this machine; pick a saved SSH host to tunnel through',
  'db.connections.directHint': 'Just enter the database address',
  'db.connections.remoteHost': 'Host address (as seen from the SSH host)',
  'db.connections.remotePort': 'Port',
  'db.connections.passwordKeep': 'Leave blank to keep the current password',
  'db.connections.tls': 'Encryption (TLS)',
  'db.connections.tlsDisable': 'Off',
  'db.connections.tlsRequire': 'Encrypt, do not verify the certificate',
  'db.connections.tlsVerify': 'Encrypt and verify the certificate',
  'db.connections.tlsHint': 'A direct connection is unencrypted by default. Verify is the safe choice; the middle option covers a self-signed certificate. Not needed over an SSH tunnel.',
  'db.connections.filePath': 'Database file',
  'db.connections.filePathHint': 'SQLite is a file on this machine — no host, port or credentials, and nothing to tunnel.',
  'db.workspace.run': 'Run',
  'db.workspace.cancel': 'Cancel',
  'db.workspace.connecting': 'Connecting…',
  'db.workspace.rowsAffected': '{count} rows affected',
  'db.workspace.rowCount': '{count} rows',
  'db.workspace.filterRows': 'Filter rows…',
  'db.workspace.prevPage': 'Previous',
  'db.workspace.nextPage': 'Next',
  'db.workspace.pageRange': 'Rows {from}–{to}',
  'db.workspace.perPage': '{count} / page',
  'db.workspace.truncated': 'Results truncated to the first {count} rows.',
  'db.schema.title': 'Schema',
  'db.schema.refresh': 'Reload schema',
  ...
  'db.designer.title': 'Design table',
  'db.designer.newTable': 'New table',
  'db.designer.tableName': 'Table name',
  'db.designer.column': 'Column',
  'db.designer.type': 'Type',
  'db.designer.nullable': 'Null',
  'db.designer.primaryKey': 'Key',
  'db.designer.default': 'Default',
  'db.designer.addColumn': 'Add column',
  'db.designer.removeColumn': 'Remove column',
  'db.designer.preview': 'SQL preview',
  'db.designer.noChanges': 'No changes to apply.',
  'db.designer.apply': 'Apply',
  'db.designer.applying': 'Applying…',
  'db.designer.cancel': 'Cancel',
  'db.schema.design': 'Design table',
  'db.schema.newTable': 'New table',
  'db.schema.dropTable': 'Drop table',
  'db.schema.dropTableConfirm': 'Drop {name}? This cannot be undone.',
  ...
  'db.export.xml': 'XML',
  'db.export.html': 'HTML',
  'db.dump.export': 'Dump database',
  'db.dump.restore': 'Restore…',
  'db.dump.running': 'Reading every table…',
  'db.dump.restoring': 'Replaying the file…',
  'db.dump.chooseFile': 'Choose a .sql file to replay',
  'db.dump.empty': 'That file holds no statements.',
  'db.dump.restoreConfirm': 'Run {count} statements from this file against the connected database? This cannot be undone.',
  'db.builder.open': 'Query builder',
  'db.builder.title': 'Query builder',
  'db.builder.table': 'Table',
  'db.builder.selectTable': 'Pick a table to start.',
  'db.builder.columns': 'Columns',
  'db.builder.allColumnsHint': 'Select none for every column.',
  'db.builder.filters': 'Filters (all must match)',
  'db.builder.addFilter': 'Add filter',
  'db.builder.sort': 'Sort',
  'db.builder.addSort': 'Add sort',
  'db.builder.limit': 'Row limit',
  'db.builder.preview': 'SQL',
  'db.builder.apply': 'Put in editor',
  'db.builder.close': 'Close',
  'db.import.title': 'Import data',
  'db.import.chooseFile': 'Choose a CSV or JSON file…',
  'db.import.targetTable': 'Target table',
  'db.import.createTable': 'Create the table from the file',
  'db.import.preview': 'Preview',
  'db.import.rowsFound': '{count} rows, {columns} columns',
  'db.import.run': 'Import',
  'db.import.running': 'Importing…',
  'db.import.cancel': 'Cancel',
  'db.import.failed': 'Could not read the file.',
  'db.schema.import': 'Import data…',
  ...
  'db.history.title': 'Query history',
  'db.history.filter': 'Search history…',
  'db.history.empty': 'No queries yet.',
  'db.history.favourite': 'Save this query',
  'db.history.favouritesOnly': 'Saved queries only',
  ...
  'db.er.close': 'Close',
  'db.diff.title': 'Compare structure',
  'db.diff.explain': 'Compares another connection against "{source}" and writes a script to bring it in line.',
  'db.diff.target': 'Compare against',
  'db.diff.pick': 'Select a connection…',
  'db.diff.noCandidates': 'Save another connection to compare against.',
  'db.diff.safety': 'Only statements that add things are runnable. Anything that can lose data — drops, type changes, tightening nullability — comes out commented so you can read it and decide.',
  'db.diff.compare': 'Compare',
  'db.diff.reading': 'Reading table {done} of {total}…',
  'db.diff.close': 'Close',
  ...
  'vault.hosts.bulkEdit.action': 'Edit {count}',
  'vault.hosts.bulkEdit.title': 'Edit selected hosts',
  'vault.hosts.bulkEdit.description': 'Applies to {count} host(s).',
  'vault.hosts.bulkEdit.blankHint': 'Leave a field blank to keep the existing value on each host.',
  'vault.hosts.bulkEdit.username': 'Username',
  'vault.hosts.bulkEdit.group': 'Group',
  'vault.hosts.bulkEdit.port': 'Port',
  'vault.hosts.bulkEdit.addTags': 'Add tags (comma separated)',
  'vault.hosts.bulkEdit.managedSkipped': '{count} managed host(s) are excluded — a data source would overwrite the change on its next sync.',
  'vault.hosts.bulkEdit.apply': 'Update {count}',
  'vault.hosts.bulkEdit.success': 'Updated {count} host(s)',
