export const zhCNScriptsMessages = {
  ...
  'scripts.trigger.actions': '匹配后动作',
  'scripts.trigger.actionsHint': '输出匹配模式时执行的动作。默认仍为运行脚本。',
  'scripts.trigger.action.runScript': '运行脚本',
  'scripts.trigger.action.notify': '桌面通知',
  'scripts.trigger.action.sound': '播放声音',
  'scripts.trigger.action.markTab': '标记标签',
  'scripts.trigger.action.startSessionLog': '开始会话日志',
